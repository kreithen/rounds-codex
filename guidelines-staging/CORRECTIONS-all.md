...
### Anesthesiology 2025 #3 — Individualized Perioperative Blood Pressure Management in Patients Undergoing Major Abdominal Surgery: The IMPROVE-multi Randomized Clinical Trial

**replaced — original stated the opposite result**

The original cited an 'HPI-SMART Trial' that does not exist, said it showed individualized relative MAP targets significantly reduce AKI and myocardial injury, and said international hemodynamic standards were rewritten to recommend targeting within 10-15% of baseline. IMPROVE-multi is the real 2025 JAMA trial on this exact question and found no benefit. The entry now states the actual finding.

### Anesthesiology 2025 #10 — Viscoelastometric-Guided Early Fibrinogen Concentrate Replacement during Postpartum Haemorrhage (OBS2)

**replaced — original stated the opposite result**

The original cited a 2025 Lancet multicentre trial proving VHA-guided fibrinogen reduces ICU admissions and blood product exposure, and said obstetric hemorrhage standards now strongly recommend it over plasma. No such trial exists. OBS2 is the real randomized trial of this intervention and it was negative, as was FIDEL. The entry now reports that, and keeps the genuinely useful role of viscoelastic testing.

### Anesthesiology 2026 #2 — Intervals for Oscillometric Arterial Pressure Monitoring during Noncardiac Surgery: The 2.5-Minute versus 5-Minute Randomized Clinical Trial

**corrected — original stated the opposite result**

The trial is real (NCT06314074) and it was NEGATIVE. The original said it proved shorter intervals reduce hypotensive depth and duration, and told readers to shorten NIBP cycling to 2.5 minutes during induction and high-risk phases — the opposite of what the trial found, and a practice change based on a null result. Rewritten to the actual finding, with the norepinephrine confound that explains it.

### Cardiology 2025 #5 — Early Intervention in Patients With Asymptomatic Severe Aortic Stenosis and Myocardial Fibrosis (EVOLVED)

**corrected — original stated the opposite result**

The trial is real and correctly journaled and dated, but it was NEGATIVE. The original said early TAVR 'significantly lowers 3-year mortality and heart failure re-admission' and that guidelines shifted it from class IIb to class I. Neither is true: HR 0.79 (95% CI 0.44-1.43), P = .44, 'no demonstrable effect', and no guideline class change occurred. Two further points added: the intervention was aortic valve replacement generally, not TAVR specifically, and the trial recruited only 224 of 356 planned patients.

### Cardiology 2025 #8 — Left Atrial Appendage Closure versus Best Medical Therapy in AF at High Risk of Stroke and Bleeding (CLOSURE-AF)

**corrected — original stated the opposite result**

The trial is real (AHA, 8 November 2025, Landmesser, 912 patients, 42 sites) but the result is the REVERSE of the original entry. The original said it proved noninferiority for stroke prevention with a dramatic bleeding reduction, and that guidelines now recommend LAAC as an early first-line alternative to NOACs at high HAS-BLED. LAAO did not meet noninferiority; medical therapy including anticoagulation was better. The comparator was also best medical care, not NOACs alone.

### Dermatology 2025 #7 — Emollients to Prevent Pediatric Eczema: A Pragmatic and Decentralized Randomized Clinical Trial (CASCADE)

**corrected — population and formulation claims reversed**

The trial is real and POSITIVE (JAMA Dermatology, 23 July 2025, 1,247 dyads, 25 clinics). Two substantive corrections. The original said the trial clarified 'which formulations (ceramide-dominant vs standard petrolatum)' benefit — it made no formulation comparison; a single bland moisturizer was used. And the original attributed the benefit to 'infants with genetic skin-barrier susceptibility' — CASCADE explicitly did NOT select for AD risk, and trials in atopy-prone infants have been negative, so the population claim was backwards.

### Dermatology 2025 #8 — Nicotinamide for Skin Cancer Chemoprevention: A Real-World Cohort Study
...
### Orthopaedic Surgery 2025 #2 — Physical Therapy Adds Nothing to Structured Home Exercise in Meniscal Tear with Knee Osteoarthritis (TeMPO)

**REVERSED — the result was submitted in the opposite direction**

Real trial (TeMPO, NEJMoa2503385, 29 Oct 2025, n=879). THE FINDING WAS STATED BACKWARDS. The submission says supervised physical therapy offered 'modest additional benefit over self-directed home exercise programs alone'. The trial found the opposite: no meaningful additional pain relief from standard PT, sham PT or adherence texts on top of home exercise, difference 2.5 points and not significant. This is a negative trial and its clinical value is precisely that it is negative — rewritten to say so, with the four arms named so the reader can see what was actually compared.

### Orthopaedic Surgery 2026 #10 — Extended Antibiotic Prophylaxis in High-Risk Arthroplasty: Genuine Equipoise, Not a Negative Result

**REVERSED — the submitted finding runs against the weight of the evidence**
...
The schedule is real (policy statement 26 January 2026, Pediatrics 157(3):e2025075754, Red Book Online, 18 diseases, hepatitis B within 24 hours of birth). THE FRAMING IS BACKWARDS ON THE POINT THAT MATTERS MOST. The submission says the AAP 'issued unified guidance', that it 'Reaffirms evidence-based national standards' and that it creates 'a synchronized clinical framework across primary care, obstetrics, and pediatric subspecialties'. In fact the 2026 schedule BROKE with the CDC: AAP covers 18 diseases to the CDC's 11, ending decades of harmonisation, after ACIP moved infant hepatitis B (including the birth dose) and COVID-19 vaccination from universal to shared clinical decision-making. Twelve other national organisations and 28 states have endorsed the AAP schedule over the CDC's. Describing this as synchronised national guidance would leave a resident unaware that two conflicting schedules exist, which is now a routine clinical and consent problem. Rewritten around the divergence, with the hepatitis B birth dose called out because it is the difference with the least recoverable consequence. The submission's co-sponsor list (AAFP, PIDS, ACOG, NAPNAP) is not asserted as I could not confirm it for this edition.

### Plastic Surgery 2026 #3 — Regenerative Adjuncts in Aesthetic Surgery: PRF and Nanofat Are Not Exosomes
...
### Cardiology 2025 #6 — Antithrombotic Therapy for Atrial Fibrillation with Stable Coronary Disease (AFIRE)

**replaced — cited trial does not exist**

There is no 'OAC-ALONE 2' trial. The clinical teaching in the original was CORRECT and is supported — by AFIRE (NEJM 2019), which found monotherapy noninferior for efficacy, superior for safety, and with lower all-cause death. Only the citation is replaced. The real OAC-ALONE (2019) is mentioned because it is the trial the name was presumably reaching for, and its limitations explain why AFIRE is the one that settled the question.

### Cardiology 2025 #9 — Colchicine in Acute Myocardial Infarction (CLEAR SYNERGY / OASIS 9)

**replaced — cited trial does not exist and the finding is contested**

There is no 'COLCOT-2' trial. The original said a large NEJM outcomes trial 'confirmed' that colchicine significantly reduces recurrent ischemic events and that guidelines elevated it to a routine recommendation. The large 2025 NEJM trial is CLEAR SYNERGY (OASIS 9) and it was NEUTRAL: HR 0.99 (95% CI 0.85-1.16) in 7,062 patients. COLCOT and LoDoCo2 were positive, so the entry now presents the genuine controversy rather than either side of it.

### Dermatology 2026 #7 — Stapokibart for the Treatment of Refractory Palmoplantar Pustulosis
...
### Orthopaedic Surgery 2026 #7 — Timing of Geriatric Hip Fracture Fixation: What the Data Support
...
**corrected — one mandated standard does not exist**

Partly real. Confirmed: the 2025 checklist edition released 9 December renamed the section from 'Telepathology and Remote Data Assessment' to 'Digital Pathology Including Remote Data Assessment'; security procedures are required particularly for portable mobile devices used in public places; digital images used for diagnosis must be retained for 10 years where original glass slides are unavailable; validation, training documentation and quality monitoring are expected. Cybersecurity and image management are acknowledged concerns and LIS-IMS integration is an active discussion. ONE CORRECTION: the submission states that 'Revised CAP accreditation criteria mandated enhanced cybersecurity, encryption, and vendor-neutral archive (VNA) standards for cloud-based digital pathology platforms'. No vendor-neutral-archive requirement was found in CAP accreditation, and the encryption and data-sovereignty specifics were not confirmed either — a laboratory told it must adopt a VNA to pass inspection would be acting on something that does not exist. Replaced with the requirements that are documented, which are more actionable in any case. The submission's conclusion about seamless inter-institutional consultation is an aspiration rather than an accreditation outcome and is not asserted.

### Pediatrics 2026 #9 — Antibiotic Stewardship in Children and the WHO AWaRe Framework

**corrected — the cited study was not found and the target is wrong twice over**

The AWaRe framework and the over-reliance on Watch antibiotics in children are real, and the clinical advice (high-dose amoxicillin or penicillin first-line for otitis media, sinusitis and pneumonia) is sound and standard. TWO CORRECTIONS. (1) THE TARGET IS WRONG IN TWO WAYS. The submission says the work 'setting a benchmark of at least 60% total pediatric antibiotic usage originating from the narrow-spectrum Access category'. The 60% Access figure is a WHO NATIONAL target covering all ages for 2023, not a paediatric-specific benchmark, and the 79th UNGA high-level meeting on AMR has raised it to 70%. A stewardship programme auditing paediatric prescribing against a 60% paediatric target would be measuring against a number that does not exist. (2) The specific study described — 'a major international study published in The Lancet' analysing global paediatric prescribing patterns — was not found. A closely related Lancet-family paper does exist (eClinicalMedicine, 80 national paediatric guidelines against the WHO AWaRe book) and has been substituted, together with the point-prevalence figures that show the actual variation.

### Plastic Surgery 2025 #7 — Lymphaticovenous Anastomosis for Lower Extremity Lymphedema: Outcomes and Postoperative Compression
...
### Preventive Medicine 2025 #8 — Opportunistic AI Quantification of Coronary Artery Calcium on Routine Chest CT

**citation not independently verified — direction supported, specifics not confirmed**

The technical direction is real and well established in the imaging literature: deep learning can quantify coronary artery calcium from non-gated routine chest CT, and opportunistic screening from lung cancer screening scans is an active field. I did NOT verify the specific multicentre validation studies the submission attributes to The Lancet Digital Health and Radiology, and the submitted hyperlink is a journal home page rather than a paper — which is itself a signal that the citation was not pinned down. I also could not confirm the claim that this 'supported updated preventive cardiology consensus guidelines advocating for opportunistic screening'; the entry says so explicitly rather than asserting a guideline that may not exist. Two caveats added that the submission omits and that determine whether this is useful: non-gated scores are not interchangeable with dedicated gated CAC scoring, and an incidental score with no routing pathway changes no prescribing. Flagged for the physician to confirm the primary citations before this ships as authoritative.

### Preventive Medicine 2025 #9 — CONSORT 2025: Updated Reporting Guideline for Randomised Trials

**citation not independently verified — the statement is real, its contents not confirmed item by item**

CONSORT 2025 exists and was co-published across major journals including The BMJ, JAMA and The Lancet, and the submission's framing of it as the first comprehensive update since CONSORT 2010 is consistent with that 15-year gap. I did NOT verify the specific new content the submission attributes to it — 'strict reporting criteria for AI-driven interventions, digital biomarkers, patient-reported outcomes, and health equity metrics', nor that it 'mandates transparent reporting on digital therapeutics, remote monitoring algorithms, and diverse demographic representation'. Those are plausible for a 2025 revision but are asserted here in general terms only. The submission's 'mandates' is also too strong for a reporting guideline, which journals adopt rather than enforce as regulation; reworded. Flagged for confirmation against the published checklist before any specific item is quoted.

### Preventive Medicine 2025 #10 — Early Initiation of SGLT2 Inhibitors for Cardiorenal Protection in Chronic Kidney Disease

**citation not independently verified — direction well supported, cited sources not confirmed**

The clinical direction is well established: SGLT2 inhibitors reduce kidney disease progression and cardiovascular events in chronic kidney disease irrespective of diabetes status, and both KDIGO and ADA guidance support albuminuria screening and early initiation. But I did NOT verify the specific 'pooled clinical trial analyses published in The Lancet' the submission cites, and the submitted hyperlink is The Lancet's home page rather than a paper — the same signal as the AI calcium entry. 'Mandate' is also too strong for guideline recommendations and has been reworded. The entry is written around what is genuinely actionable and verifiable in primary care — annual uACR, treating albuminuria as an indication rather than an observation — rather than around a named analysis I could not pin down. Flagged for the physician to supply or confirm the primary citation.

### Psychiatry 2025 #4 — Maintenance Pharmacotherapy in Bipolar Disorder: Swedish Nationwide Cohort

**citation not independently verified — direction consistent with established evidence**

I did not verify this specific study, including the cohort size of over 105,000, the journal (submitted as The Lancet Psychiatry) or the individual hospitalisation outcomes, so none of those is asserted. The findings as described are consistent with a substantial existing literature from Swedish and Finnish national registers using within-individual designs, and with guideline positions on lithium as first-line maintenance and against antidepressant monotherapy in bipolar disorder — so the direction is credible even though the citation is unconfirmed. Rewritten to attribute the design and direction without the unverified specifics, and the limits of a within-individual observational design added, since the submission presents it as settling the question. Flagged for the physician to confirm the primary citation.

### Psychiatry 2025 #6 — Transdiagnostic Prediction of Psychosis and Bipolar Disorder in Young People

**citation not independently verified — plausible field, specific model and guideline shift not confirmed**

Transdiagnostic clinical prediction modelling in youth mental health is a real and active field, and the rationale the submission gives is sound. But I did not verify the specific validated model described, nor its publication in The Lancet Psychiatry, nor the claim that this 'transitions early-intervention guidelines away from single-disorder assessment tools toward transdiagnostic risk-screening frameworks' — that is a substantial claim about guideline change and no supporting document was found. Rewritten to describe the approach without asserting a specific validated instrument. Two limitations added that the submission omits and that determine whether such a model helps anyone: external validity across health systems, and the recognised harms of risk labelling in adolescents, which is why prodromal designation remains contested. Flagged for the physician to supply the primary citation.

### Psychiatry 2025 #7 — Psilocybin with Psychological Support in Treatment-Resistant Depression: Longer-Term Follow-Up

**citation not independently verified — journal name appears garbled**

The phase 2b psilocybin programme in treatment-resistant depression using 25 mg with psychological support is real and well known, and extended follow-up reports exist. I did not verify the specific 12-month follow-up publication or its findings, so no response or remission figure is quoted. The submitted journal, 'Psychotherapy and Psychosomatics', appears to be a garbled rendering of Psychotherapy and Psychosomatics — the citation could not be resolved either way, so it is not named. Rewritten to describe the design and to set out why naturalistic follow-up overstates durability: differential retention, continued concurrent treatment, and absence of a control group beyond the randomised window. Also stated that psilocybin is not approved for depression, which the submission's practical field does not mention. Its claim about preparation and integration sessions being 'essential' is flagged as untested rather than removed.

### Psychiatry 2025 #9 — Long-Acting Injectable Antipsychotics in First-Episode and Early-Phase Schizophrenia

**citation not independently verified — direction well supported, one claim contested**

The clinical direction is well supported in the schizophrenia literature: long-acting injectables reduce relapse and rehospitalisation relative to oral antipsychotics, particularly in early-phase illness, and the position that they should not be reserved for chronic non-adherence is widely argued. I did not verify the specific consensus document the submission cites — the link given is 'PubMed Central' generally rather than an article — so no particular statement is attributed. TWO ADDITIONS/CORRECTIONS. The submission's claim that early relapse causes 'cumulative neurostructural changes' is a contested hypothesis, not established, and the entry says so, because it is exactly the kind of claim that gets used to press a patient toward a decision. And two practical points are added that the submission omits: establishing tolerability on the oral form of the same molecule first, and the irreversibility of a depot if a serious adverse effect emerges.

### Psychiatry 2026 #3 — Cannabinoids for Psychiatric Disorders: No Evidence of Efficacy

**citation not independently verified — direction consistent with the evidence base**
...
### Psychiatry 2026 #5 — fMRI-Guided Targeting for Transcranial Magnetic Stimulation in PTSD

**citation not independently verified — plausible direction, specific trial and guideline claim not confirmed**

Individualised, connectivity-guided TMS targeting is a real research direction with a sound rationale, and reduced amygdala reactivity is a coherent hypothesis. But I did not verify the specific trial, the sustained reduction in right amygdala hyper-reactivity, or the claim that this 'elevates precision circuit-targeted neuromodulation within trauma guidelines'. The submitted citation — 'Editorial Review on Shanghai Archives of Psychiatry' — is one of five entries in this list pointing at the same journal for five unrelated topics, which is itself a reason to doubt the sourcing rather than the science. Rewritten to describe the approach and to state the practical barrier the submission omits: individual fMRI plus neuronavigation is beyond most interventional clinics, and TMS is not an established PTSD treatment. Flagged for the physician to supply primary citations.

### Psychiatry 2026 #6 — Ketogenic Diet as an Adjunct in Treatment-Resistant Depression

**citation not independently verified — evidence level overstated**

Metabolic psychiatry and ketogenic interventions in mood disorders are a real area of investigation. But the submission claims 'a randomized controlled trial evaluating a structured ketogenic diet versus a matched active comparator diet' that 'confirmed measurable improvements', and says this 'provides high-level evidence supporting metabolic psychiatry within complementary management guidelines for severe major depressive disorder'. I could not verify that trial, and the citation given is again the Shanghai Archives of Psychiatry editorial review used for four other unrelated entries. Published work in this area is predominantly pilot and open-label. Rewritten to describe the hypothesis honestly and to add the risks the submission omits — nutritional adequacy, eating-disorder history, and adherence demands in severe depression — since a supervised restrictive diet in this population is not a neutral intervention.

### Psychiatry 2026 #8 — Symptom Subtypes in Postpartum Depression

**citation not independently verified — approach real, treatment-matching claim not supported**

Latent class analysis of perinatal depressive symptoms is a real and published approach, and the argument against relying on a binary screening cutoff is reasonable. But I did not verify the specific large-scale cohort study or the five distinct profiles, and the citation given is again the Shanghai Archives of Psychiatry editorial review shared with four unrelated entries. TWO CORRECTIONS. The claim that perinatal guidelines have shifted 'from a simple screen-positive vs. screen-negative binary cutoff to a multi-dimensional risk stratification model' was not confirmed. And the practical suggestion that clinicians tailor interventions 'ranging from sleep-focused therapies to neurosteroid administration' by symptom cluster implies a validated subtype-to-treatment mapping that does not exist — reworded, with the item-level reading of the screening instrument and the self-harm item offered as what is genuinely actionable now.

### Psychiatry 2026 #9 — Maintenance Dosing of Esketamine After Remission

**citation not independently verified — the cited source is a treatment-centre marketing page**

CITATION PROBLEM FIRST: the submission's source is 'Read Practice Guidelines via Villa Treatment Center Update' — a treatment centre, not a journal or guideline body. This is the second wellness- or treatment-provider website cited as evidence across these submissions, after 'Healing Holidays Health Journal' in the preventive medicine list. The underlying question is real: esketamine maintenance dosing intervals and long-term safety are genuinely under study. But the submission asserts that follow-up trials 'showed sustained treatment-resistant depression remission WITHOUT cognitive decline or urological toxicity' and that this 'standardizes maintenance phase guidelines' — I could not verify either, and cognitive and urological safety over long-term ketamine exposure are exactly the domains that warrant continued monitoring rather than an all-clear. Rewritten so those are presented as things to monitor, and the open-label extension nature of long-term data is stated. CROSS-REFERENCE: the 2025 list carries esketamine monotherapy approval; this entry is the maintenance question.

### Psychiatry 2026 #10 — School-Based Screening and Stepped Care for Youth Anxiety

**citation not independently verified — the trial acronym does not resolve**

School-based screening and stepped-care delivery for youth anxiety is a real and active field with a sound access rationale. But the trial named in the submission, 'iCATSi2i', does not resolve as a recognisable trial acronym — the fourth apparently invented or garbled acronym across these submissions after LITH-QUE, ESTEEM and ANGLE — and the citation given is the Shanghai Archives of Psychiatry editorial review shared with four unrelated entries in this same list. I also could not confirm the reduction in clinical progression rates or the claim that guidelines now emphasise school-based over clinic-referred pathways. Rewritten around the access argument, which is defensible, with the two implementation conditions added that the submission omits: capacity to receive referrals generated by screening, and supervision plus a risk-escalation route for school staff delivering the intervention.

### Radiation Oncology 2025 #4 — Stereotactic Radiosurgery versus Hippocampal-Avoidance Whole-Brain Radiotherapy for 5 to 20 Brain Metastases

**citation not independently verified**

The clinical question is real and actively studied — randomised comparisons of SRS against hippocampal-avoidance WBRT for patients with more than four brain metastases exist, and expanding the SRS indication beyond one to four lesions is a genuine direction of travel. But I did not verify this specific multicentre trial, its publication (the submission says 'ASCO/JAMA', which are different things), or its outcomes, so no result is asserted. The claim that it redefines ASTRO and NCCN brain metastasis protocols is likewise unconfirmed. Added the two practical costs the submission omits — higher surveillance imaging and salvage burden for new lesions outside treated sites, and planning workload scaling with lesion count — since those are what determine whether SRS is deliverable for a patient with 15 metastases.

### Radiation Oncology 2025 #5 — Long-Term Outcomes of SBRT versus Surgery for Operable Early-Stage NSCLC

**citation not independently verified — one structural limitation added**

The comparison is real and long-standing, and SBRT's position as a radical option rather than only a salvage for medically inoperable patients is well argued in the literature. But I did not verify the specific ten-year randomised follow-up the submission describes, so no survival figures are quoted. ADDED, because the submission omits it and it is the standing objection: the randomised trials of SBRT versus surgery in OPERABLE patients closed early with small samples, so much comparative evidence is propensity-matched, and SBRT provides no pathological nodal staging — which affects adjuvant decision-making regardless of local control. Flagged for the physician to supply the primary citation.

### Radiation Oncology 2025 #6 — Single-Fraction versus Conventional Postoperative Radiotherapy for Recurrent NSCLC

**citation not independently verified**

Extreme hypofractionation in lung SBRT is a real direction and single-institution randomised work in this area is plausible, but I did not verify this specific Roswell Park study, its sample size, its follow-up or its outcomes, so nothing is asserted beyond the comparison it describes. The submission's claim that it 'accelerates hypofractionation guidelines' is not supported by an institutional study. ADDED: the central-structure caution, because single-fraction delivery near proximal airway, oesophagus, brachial plexus or chest wall is where dose-per-fraction escalation causes harm, and late toxicity typically emerges after the local-control endpoint is reported — a point the submission's 'fewer acute toxicities' framing obscures.

### Radiation Oncology 2025 #7 — Adjuvant Pelvic Radiotherapy After Radical Cystectomy in High-Risk Muscle-Invasive Bladder Cancer (BART)

**citation not independently verified — source is a conference-highlights blog**

The BART trial is a real trial name in this space and the question — adjuvant pelvic radiotherapy after cystectomy in high-risk muscle-invasive bladder cancer — is genuine. I did not verify the results, the primary endpoint, the sample size, or whether reduced locoregional recurrence came with any survival benefit, so the submission's 'proved that... significantly lowers local pelvic recurrence rates' is not asserted. The submitted link is a cancer-news roundup rather than a primary publication or ASTRO abstract. ADDED: the trade-off the submission omits, namely what an irradiated pelvis means for a urinary diversion and for future treatment options in that field, which is the reason adjuvant pelvic radiotherapy fell out of favour in the first place.

### Radiation Oncology 2025 #8 — Genomic Classifier-Guided Use of ADT with Salvage Radiotherapy After Prostatectomy

**citation not independently verified — study design distinction added**

The field is real: genomic classifier and luminal/basal subtype analyses of randomised salvage radiotherapy cohorts have been published and are the basis for interest in biomarker-guided ADT. I did not verify the specific validation study, so no result is asserted, and the claim that clinical practice guidelines now recommend genomic profiling before prescribing hormone therapy with salvage radiation is unconfirmed. THE IMPORTANT ADDITION is a design distinction the submission elides: these are biomarker analyses OF randomised trials, not randomised trials OF biomarker-directed treatment. Nobody has randomised men to classifier-guided versus standard ADT decisions. The submission's 'allows doctors to avoid unnecessary hormone therapy' presents the stronger claim, and withholding ADT from a man with adverse clinical features on the strength of a subtype is not yet supported.

### Radiation Oncology 2025 #10 — Olanzapine for Prevention of Radiotherapy-Induced Nausea and Vomiting
...
### Anesthesiology 2025 #2 — Long-Term Survival after Propofol or Sevoflurane Anaesthesia for Major Cancer Surgery: Follow-up of a Multicentre Randomised Trial

**replaced**

The original cited a 2025 Lancet trial providing 'definitive' 3-year recurrence-free survival data. No such trial exists, and it claimed guidelines had been changed on the strength of it. Replaced with the real randomised evidence that does exist, and the practice conclusion — technique choice is not an oncologic decision — is preserved and now correctly sourced.

### Anesthesiology 2025 #5 — Low versus High Intraoperative Fraction of Inspired Oxygen and Postoperative Organ Complications: A Systematic Review and Meta-Analysis of Randomized Controlled Trials

**replaced — original overstated a nonexistent trial**

The original cited a 2025 NEJM pragmatic trial proving intraoperative hyperoxia increases pulmonary complications, and said major societies had rewritten oxygen guidelines to a 92-96% SpO₂ target. No such trial was found and no such target has been adopted. The 'high FiO₂ does not reduce SSI' half was correct and is retained with its real source; the rest now reports what the evidence actually shows, including that low FiO₂ carries its own harm signal.

### Anesthesiology 2025 #7 — Restrictive versus Liberal Red-Cell Transfusion in Cardiac Surgery (TRICS III)

**corrected — wrong trial name and year**

The original called this the 'TITRE-3 Trial' and dated it 2025 with a '90-day MACCE' endpoint. No trial by that name exists; the description is TRICS III, NEJM 2017. The clinical teaching was correct throughout and is unchanged — only the citation, year and endpoint description are fixed, with the trial's actual numbers added. (TITRe2 is a separate, earlier UK trial with a different design.)

### Anesthesiology 2025 #8 — Spinal versus General Anaesthesia for Hip Fracture Surgery: Systematic Review and Meta-Analysis Using a Consensus Core Outcome Set (REGAIN and RAGA)

**corrected — wrong trial name and year**

The original cited a 2025 'RACE-2 Trial' in JAMA Surgery with processed-EEG-guided GA as the comparator. No such trial exists. The conclusion is well supported, by REGAIN (NEJM 2021) and RAGA (JAMA 2022) and this BJA meta-analysis synthesising them with a consensus core outcome set. Teaching preserved, citations corrected, real numbers added.

### Cardiology 2025 #10 — Intravenous Tenecteplase before Thrombectomy in Stroke (BRIDGE-TNK)
...
**corrected — one performance figure wrong, and the 2026 duplicate of this entry removed**

Real: CellNuc-DETR (arXiv 2502.06307) adapts DETR with deformable attention to detect and classify nuclei without segmentation masks, with public code, and LSP-DETR follows it. THREE CORRECTIONS. (1) FIGURE WRONG: the submission claims 'up to a 40-fold reduction in post-processing time'. The reported results are 2x faster than HoVer-NeXt with higher accuracy and roughly 10x more efficient than CellViT on whole-slide inference; the 40-fold figure is not in the work and has been replaced with the actual comparisons. (2) The submission says it 'shifts computational pathology standards' and enables quantification 'directly within routine diagnostic workflows'; this is a preprint with benchmark results and no clinical validation or clearance, which the entry now states. The ECDP presentation could not be confirmed, so the arXiv record is cited instead. (3) DEDUPLICATION: the pathology 2026 submission contains an entry ('Direct Whole-Slide Transformer Models Replace Pixel-Wise Segmentation') making the same claim about the same development. Under the rule applied to neurosurgery, obstetrics and neurology, a development appears under one year only, so that entry has been dropped and 2026 carries nine entries. Its one distinct point — that this removes the need for heavy local GPU infrastructure — is folded into the impact field here.

### Pathology 2025 #9 — The Ferritin Threshold for Iron Deficiency in Anaemia Is 45 ng/mL, Not 15

**corrected — real threshold, wrong attribution and wrong year**

The 45 ng/mL threshold is real and is a strong recommendation on high-quality evidence, with the sensitivity and specificity figures confirmed (85%/92% at 45, 59%/99% at 15). TWO CORRECTIONS. (1) Attribution and date: the submission credits 'Gastroenterology and Clinical Pathology joint consensus guidelines' that 'formally updated' the threshold as a 2025 development. It is the AGA clinical practice guideline published in Gastroenterology in 2020; what is recent is 2025 work on the effect of adopting it. Presenting a five-year-old recommendation as new would also mislead a laboratory into thinking it had time to comply. (2) The submission's claim that it 'Mandates updated laboratory reference ranges and clinical decision alerts' overstates a clinical practice guideline, which recommends rather than mandates — reworded to what a laboratory should check. ADDED: the inflammation and chronic kidney disease caveat, which the submission omits and which is where the threshold misleads most often.

### Pathology 2026 #5 — Biomarker Testing in Gastroesophageal Adenocarcinoma: HER2, PD-L1, MMR/MSI and Claudin 18.2

**corrected — wrong issuing body for the newest biomarker guidance**

Partly right, with the attribution wrong where it matters most. The HER2 content checks out and is a real CAP/ASCP/ASCO guideline: reporting per the CAP HER2 (ERBB2) template, identifying invasive adenocarcinoma and marking the strongest-intensity areas for subsequent in situ hybridization, IHC with reflex ISH. TWO CORRECTIONS. (1) The submission says 'Updated clinical guidelines presented at USCAP established refined testing cascades for HER2, Claudin 18.2, and MMR/MSI' and that these set 'strict tissue-sampling and scoring thresholds for emerging targeted biomarkers like Claudin 18.2'. The four-marker panel recommendation is NCCN 2026, not a CAP or USCAP guideline, and for claudin 18.2 the literature states explicitly that no specific practical testing guidelines have been proposed yet — a Modern Pathology practical-approach paper is what exists. There are therefore no guideline scoring thresholds for CLDN18.2 to cite, and the entry says so. (2) PD-L1 was missing from the submitted panel and has been added, since it is one of the four markers driving first-line choice. The tissue-triage message was the submission's strongest point and is kept.

### Pediatrics 2025 #3 — Omalizumab for Multiple Food Allergies (OUtMATCH Stage 1)

**corrected — 'disease-modifying' is wrong, and the avoidance advice was unsafe**

The trial is real and the results check out: OUtMATCH stage 1, NEJMoa2312382, 180 participants aged 1-55 (177 children/adolescents), 67% versus 7% on the primary endpoint, FDA approval 16 February 2024. FOUR CORRECTIONS. (1) The submission calls omalizumab 'a disease-modifying monotherapy'. It is not disease-modifying — the FDA indication is reduction of reactions on accidental exposure, the benefit is threshold-raising, and it depends on continued dosing. (2) SAFETY: the submission says it eases 'reliance on strict food avoidance'. It does not. Patients must continue strict avoidance and carry adrenaline; a family told otherwise could feed a child an allergen. That is the most consequential error in this list and the entry now states the opposite explicitly. (3) 'Led to updated AAP and AAAAI allergy guidelines' could not be confirmed; the FDA approval is the verifiable regulatory event and is cited instead. (4) Trial name is OUtMATCH, not OUToMATCH; date 2024, not 2025.

### Pediatrics 2026 #5 — Topical Berdazimer Gel 10.3% for Molluscum Contagiosum (B-SIMPLE4)

**corrected — efficacy overstated and the date is wrong by four years**

The trial is real with the numbers confirmed: B-SIMPLE4, 891 patients aged ≥6 months with 3-709 lesions, complete clearance 32.4% versus 19.7% vehicle at week 12 (P<.0001), week 8 19.6% versus 11.6%, week 4 7.2% versus 3.6%, TEAEs 43.0%, 4.1% discontinuation, none serious. TWO CORRECTIONS. (1) EFFICACY: the submission says the gel 'reliably accelerating viral resolution' and achieved 'statistically significant complete clearance... with minimal localized side effects'. Statistically significant is right; reliable is not — two thirds of treated children had not cleared at 12 weeks, the absolute gain over vehicle is about 13 percentage points, and 43% had a treatment-emergent adverse event, which is not minimal. Both corrected, since this is exactly the entry a parent will be quoted. (2) DATE: B-SIMPLE4 was published in 2022 and berdazimer was FDA approved in January 2024 — it is not a 2026 development. The date field states this; the entry is left on the submitted year, as with other out-of-year citations in this project.

### Plastic Surgery 2025 #2 — International Delphi Consensus on Aesthetic Management of Medication-Driven Weight Loss

**matched with corrections — journal wrong, sponsorship disclosed, key recommendation added**
...
### Psychiatry 2026 #7 — Mirtazapine for Methamphetamine Use Disorder (Tina Trial)

**corrected — 'first-line' overstates a modest effect, and the journal citation was wrong**

Verified: the Tina Trial, JAMA Psychiatry 2026, phase 3 multisite double-blind placebo-controlled parallel-arm randomised trial at six government-run outpatient AOD clinics in Australia, adults 18-65 with moderate or severe methamphetamine use disorder, modest but statistically significant reduction in use over 12 weeks, drowsiness 47% versus 33% and weight gain 10% versus 3%. THREE CORRECTIONS. (1) The submission says this 'updates addiction psychiatry clinical guidelines to recommend mirtazapine as a FIRST-LINE pharmacological option'. The source characterises the benefit as modest, mirtazapine has no approval for this indication, and no guideline change was found — so first-line is not supportable. (2) CITATION: the submission attributes this to a Shanghai Archives of Psychiatry editorial review; it is JAMA Psychiatry. (3) Added the effect size, the side-effect rates and the off-label status, none of which the submission gives, plus the earlier Coffin trial as context.

### Radiation Oncology 2025 #1 — Intensity-Modulated Proton Therapy versus IMRT for Oropharyngeal Cancer: Phase III Randomized Trial

**matched with corrections — verified, and I was wrong to doubt it**

VERIFIED, INCLUDING THE SURVIVAL CLAIM I EXPECTED TO FAIL. Having established for the otolaryngology list that TORPEdO's result was toxicity rather than survival, I expected a 10% absolute OS gain for protons to be an overstatement. It is not: this is a separate MD Anderson-led phase III trial, 440 patients (221 IMPT / 219 IMRT), randomised October 2013 to May 2022, published in The Lancet, with 5-year overall survival 90.9% versus 81.0% and a 33% relative / 13% absolute reduction in gastrostomy-tube dependence. It is described as the first trial to demonstrate a survival benefit for proton therapy. TWO CORRECTIONS. (1) The primary endpoint was PFS NON-INFERIORITY, which the trial met; overall survival is a secondary finding in an open-label design, and the entry says so because that is how the result will be challenged. (2) The submitted link is to proton-therapy.org, a proton therapy advocacy site, not The Lancet — replaced with The ASCO Post's report. Added the distinction from TORPEdO so the two trials are not conflated across the app.

### Radiation Oncology 2025 #3 — Neoadjuvant 177Lu-PSMA Before Ablative Radiotherapy in Oligorecurrent Prostate Cancer (LUNAR)
...
### Thoracic Surgery 2025 #4 — Robotic Versus VATS Resection After Neoadjuvant Chemoimmunotherapy

**corrected — the conversion figures are wrong, and no guideline update exists**

The clinical claim is supported but the numbers are not. The submission states conversion of '3.1% vs. 8.9%' for RATS versus VATS; the published comparative figures are 7.5% versus 28.2% (P<0.001), with a meta-analysis OR of 0.28 — both arms are substantially higher than submitted, and the gap is much wider. Corrected. The submission also claims the finding 'updates thoracic surgical society guidelines to recommend robotic platforms for complex post-immunotherapy hilar dissections and high-station N2 lymphadenectomy'; no such society guideline could be found, and that sentence has been removed. 'Multi-center trial analyses' overstates the evidence, which is retrospective comparative series plus a meta-analysis of them — restated. Retained and verified: lower conversion, higher node and station counts, no difference in complete resection/operative time/blood loss, and equivalent perioperative and oncological safety. Added a caution on the yp-N0/yp-N2 contrast, which the submission did not report and which is more likely case-mix than staging superiority.

### Thoracic Surgery 2026 #3 — STS 2026: Nodal Assessment, Upstaging and Survival in Node-Negative NSCLC

**corrected — upstaging rate and nodal threshold both wrong**

The presentation is real: Seder, J. Maxwell Chamberlain Memorial Paper in General Thoracic Surgery, STS 2026 Annual Meeting, 31 January 2026, STS National Database, 48,779 clinically node-negative NSCLC patients. Three corrections. (1) UPSTAGING: the submission says extended sampling 'alters pathologic staging in up to 14% of cT1-T2' cases; the reported figure is 11.2%. (2) THRESHOLD: the submission specifies '>10 nodes across at least 3 N2 stations'. The 2021 North American standard is three N2 stations plus one N1 node, and this study's actual recommendation is that more than one N1 node be removed — a specific, modest change, not a ten-node count. A fabricated numerical threshold in a quality metric is the kind of detail that gets audited against, so it has been replaced with what was presented. (3) The submission claims the work 'establishes stricter quality benchmarks... PENALIZING non-systematic sampling in quality metrics'; no such penalty exists — this is a presented database analysis, not an adopted metric. Also restated as a conference presentation rather than 'a trial', and added the practical point the submission omitted: stations must be submitted separately for the finding to be usable.

### Thoracic Surgery 2026 #6 — Extended Arch Versus Hemiarch Replacement in Older Patients With Type A Dissection

**corrected — right conclusion, wrong registry, wrong forum, wrong age cut-off**

The finding of no survival difference is confirmed, but nothing about the attribution was correct. The study is Arima, Sato and Tanaka, Interdisciplinary CardioVascular and Thoracic Surgery, published 10 January 2026, volume 41 issue 1, ivag017 — a retrospective analysis of the SHIZUOKA KOKUHO DATABASE, a Japanese prefecture-wide administrative CLAIMS database, in patients aged ≥60, 774 patients with 167 propensity-matched pairs. The submission describes 'a prospective STS registry study presented at STS 2026' in 'patients over 65'. Every one of those is wrong: not STS, not prospective, not presented at STS 2026, and the age threshold is 60. The submission also claims identical 'reintervention rates', which was not among the verified outcomes, and asserts the finding 'slashes operative hypothermic circulatory arrest times and lowers perioperative stroke' — those come from the separate meta-analysis (23 studies, 4,576 patients), which ALSO found hemiarch carries HIGHER LATE MORTALITY, a counterweight the submission omitted entirely. Both sides are now stated, along with the reason the trade-off resolves differently by age and the limitation that claims data cannot see tear location.

### Urology 2026 #2 — POTOMAC: Durvalumab Plus BCG in BCG-Naive High-Risk NMIBC

**matched with corrections — hazard ratio exact, forum wrong, and a five-fold toxicity increase was omitted**

Verified: POTOMAC, Lancet 2025 (PubMed 41115436), 1,018 patients randomised 1:1:1, median follow-up 60.7 months, DFS HR 0.68 (0.50–0.93), P=.0154, 32% risk reduction, 67 (20%) versus 98 (29%) DFS events, median DFS not reached in either arm; FDA approved. The submission's HR and 32% figure are exactly right. Corrections. (1) FORUM: the submission says 'Five-year follow-up results presented at AUA 2026'; the final analysis was presented at ESMO 2025 and published in The Lancet. (2) TOXICITY OMITTED: grade 3–4 treatment-related adverse events were 21% with durvalumab plus BCG induction and maintenance versus 4% with BCG alone. In a BCG-NAIVE population — most of whom do well on BCG — a five-fold increase in serious treatment-related toxicity for a disease-free survival gain is the central trade-off, and the submission did not mention toxicity at all. Restored. (3) The submission omits the third arm's result: induction-only durvalumab did not carry the benefit, which makes maintenance part of the regimen rather than optional. (4) 'Positions systemic chemo-immunotherapy combination protocols as a potential front-line standard' overstates — this is checkpoint inhibition with BCG, not chemo-immunotherapy, and FDA approval is stated in place of a guideline claim.

---

## Corrected — dates, journals, numbers, strength of claim

### Anesthesiology 2025 #1 — Multi-Society Clinical Practice Guidance on Perioperative Management of GLP-1 Receptor Agonists

**corrected**

Was titled and dated as a 2025 ASA guideline. It is a five-society clinical practice guidance released December 2024. Clinical content was accurate and is unchanged; the title, attribution and date now match the document.

### Anesthesiology 2025 #4 — ASA Practice Guideline for Monitoring and Antagonism of Neuromuscular Blockade

**corrected**

Was presented as a new 2025 guideline. It is the ASA guideline published in 2023. Every clinical claim checked out and is unchanged; the date and title now match. Also softened 'mandated' to what the document does — it recommends.

### Anesthesiology 2025 #6 — Elective Peri-operative Management of Adults Taking GLP-1 Receptor Agonists, GIP Agonists and SGLT2 Inhibitors: A Multidisciplinary Consensus Statement

**corrected**

Two errors fixed. The original said 'Endorsed by Circulation' — it was published in Anaesthesia and not endorsed by Circulation. And the hold is 3 days, not '3-4 days'. Added the consensus's own statement that no Class 1 evidence exists, since a resident should know this is expert opinion.

### Anesthesiology 2025 #9 — 2024 AHA/ACC Multisociety Guideline for Perioperative Cardiovascular Management for Noncardiac Surgery

**corrected**

Three fixes. It is a 2024 full guideline, not a 2025 focused update. It is not joint with ESAIC — it is a nine-society US document. And the original claim that early detection 'measurably lowers 1-year mortality' is not something the guideline asserts, so it has been reworded to what detection actually does.

### Anesthesiology 2026 #1 — 2026 ASA Practice Guideline on Perioperative Pain Management Using Local and Regional Analgesia for Cardiothoracic Surgeries, Mastectomy, and Abdominal Surgeries

**corrected**

The document is real and correctly cited. The original said the guideline elevated fascial plane blocks to 'Strong Recommendation' status for open surgeries in both adults and children. It is conditional for adults (and for minimally invasive cardiothoracic surgery plus open hernia repair, not open surgery generally); strong only for children after open cardiac or thoracic surgery. The guideline's own stated evidence limitations have been added.

### Anesthesiology 2026 #3 — Videolaryngoscopy versus Direct Laryngoscopy for Double-Lumen Tube Intubation: The DOLVI Multicentre Randomized Trial

**corrected**

Real and accurately summarised, including the first-attempt success figures. One softening: the original said the trial 'directly updates thoracic airway management guidelines'. It has not — that is the editorialist's question, not a guideline revision.

### Anesthesiology 2026 #4 — Management of Direct Oral Anticoagulants in Adult Patients Undergoing Cardiac Surgery: A Joint Consensus Statement by the SCA and STS

**corrected**

Real and correctly attributed. One softening: the original presented reduced bleeding, transfusion and re-operation as achieved outcomes. They are the consensus's goals; a consensus statement cannot demonstrate them.

### Anesthesiology 2026 #5 — Efficacy and Safety of Remimazolam Tosylate versus Propofol for Sedation of Postoperative Mechanically Ventilated Patients in Intensive Care Units: A Phase 3 Trial

**corrected**

Real (PMID 41855428, NCT06222294). Two fixes: the trial studied SHORT-TERM sedation, not 'prolonged postoperative mechanical ventilation' as the original title and practical implications both stated; and the original said it 'formally integrates remimazolam into PACU and surgical ICU guidelines', which has not happened.

### Anesthesiology 2026 #6 — Guidelines to the Practice of Anesthesia (Revised 2026 Edition)

**corrected — two specific claims removed as unverified**

The document is real (PMID 41820767). Removed: 'a comprehensive overhaul', which contradicts CAS's own description of targeted annual revision; a new requirement for continuous micro-stream capnography in all sedation locations including NORA; and formal institutional plans to phase out desflurane. Those last two could not be confirmed from the abstract, and the proxy blocks the full text from this container. If they are in the document, they are worth stating — but they should be checked against it first, not asserted.

### Anesthesiology 2026 #7 — Electroencephalographic Monitoring in the Recovery Room for Identification of Patients at Risk for Postoperative Delirium

**corrected**

Real (PMID 41983562). Two softenings: 'accurately identifying patients at high risk' overstates a risk-association finding, and the original said the study 'refines perioperative brain health guidelines by recommending post-anesthesia EEG screening'. The authors propose it; no guideline recommends it.

### Anesthesiology 2026 #8 — Aspirin versus Clopidogrel for Chronic Maintenance Monotherapy after PCI: 10-Year Follow-up of the HOST-EXAM Trial

**corrected**

Real and accurately summarised. Added the trial's numbers and, importantly, that all-cause mortality did not differ — the original's 'maintains superior reductions in major adverse cardiovascular events' implies a mortality benefit that was not found. Also flagged that the perioperative implications are extrapolation.

### Anesthesiology 2026 #9 — Expert Consensus Statement on the Perioperative Management of Adult Patients Undergoing High-Risk Thyroidectomy

**corrected**

Real (DOI 10.1213/ANE.0000000000008141, 10 June 2026). Two fixes: it is from the Society for Head and Neck Anesthesia, not 'multi-society'; and 'significantly reduces permanent vocal cord paralysis rates' is an intended benefit, not a measured outcome of a consensus statement.

### Anesthesiology 2026 #10 — Feasibility of a Multicomponent Protocol to Promote Dreaming during Surgical Anesthesia

**corrected — original credited it with outcomes it never measured**

The study is real but the original entry described it as an EEG-guided emergence bundle that markedly reduced emergence agitation and post-traumatic stress responses, and said processed EEG emergence tracking had entered post-anaesthesia recovery standards. It measured DREAMING. It did not measure agitation or PTSD, and no standard has changed. Rewritten to what the study actually did and found.

### Cardiology 2025 #2 — Efficacy and Safety of Baxdrostat in Uncontrolled and Resistant Hypertension (BaxHTN)

**corrected**

Real (NEJMoa2507109) and the efficacy claim holds, with numbers now added. Two fixes. The original said baxdrostat caused no clinically significant hyperkalemia — elevated potassium occurred in 2.3-3.0%. And it said the trial 'directly influenced updated AHA/ACC hypertension guidelines, adding aldosterone synthase inhibition as a novel class recommendation'; the drug was not FDA-approved until May 2026, so it could not have been a class recommendation in a 2025 guideline. Replaced with the FDA approval, which is the real and more useful news.

### Cardiology 2025 #3 — Early Aspirin Discontinuation after PCI in Low-Risk Acute Myocardial Infarction (TARGET-FIRST)

**corrected**

Real, presented at ESC 2025 with simultaneous publication in the NEW ENGLAND JOURNAL OF MEDICINE — the original cited The Lancet. Two other fixes: 'cutting major bleeding complications by more than half' is a specific magnitude that could not be confirmed, so it is now stated as reduced bleeding; and 'routinely stop aspirin 4 weeks after stenting' over-generalises a trial restricted to low-risk, completely revascularized, event-free patients. The design detail matters and has been added.

### Cardiology 2025 #4 — Tirzepatide in Patients with Heart Failure with Preserved Ejection Fraction and Obesity (SUMMIT)

**corrected**

Real and the 38% figure is right. Two fixes. DATE: presented at AHA and published in NEJM in November 2024, not 2025. And the original said it 'Rewrote Heart Failure Society guidelines to recommend dual GIP/GLP-1 receptor agonists alongside SGLT2 inhibitors as primary disease-modifying therapy' — that has not happened, and the drug is not approved for this indication. Trial size and the CMR substudy findings added. The url points at the JACC CMR substudy, which is openly accessible; the parent trial is NEJM 2024.

### Cardiology 2025 #7 — Optical Coherence Tomography-Guided versus Angiography-Guided PCI for Complex Lesions (OCCUPI)

**corrected — trial name and year**

There is no 'OCCAMI' trial. The description matches OCCUPI, The Lancet 2024. The teaching is correct and unchanged; name, year and numbers are now right. One softening: the original claimed significantly lower rates of target vessel failure, stent thrombosis AND cardiac death individually — the primary endpoint was the composite MACE, and individual components in a trial this size are not separately powered.

### Cardiology 2026 #1 — 2026 ACC/AHA/Multisociety Guideline on the Management of Dyslipidemia

**matched with corrections**

Real and largely accurate. Circulation DOI 10.1161/CIR.0000000000001423, PMID 41824590, released 13 March 2026. Universal once-in-a-lifetime Lp(a) at Class I, the three reintroduced targets, PREVENT-ASCVD and replacement of the 2018 guideline all confirmed. Two claims removed: 'broadens statin therapy recommendations to tens of millions of additional adults' could not be confirmed and is contestable, since PREVENT generally yields lower absolute risk estimates than the pooled cohort equations it replaces; and CAC scoring as a 'standard tool' overstates its role as a selective risk-decision aid. Eleven-society authorship and the retitling added.

### Cardiology 2026 #3 — Evolocumab in Patients without a Previous Myocardial Infarction or Stroke (VESALIUS-CV)

**matched with corrections**

Real and the 25% MACE figure is right. NEJM DOI 10.1056/NEJMoa2514428. DATE: published in NEJM in November 2025 and first presented at AHA 2025; it was presented again at ACC 2026 in March, which is presumably the source of the 2026 attribution. One framing note: 'primary prevention' is loose — many enrolled patients had established atherosclerosis without a prior MI or stroke, which is not the same thing. The 31% figure applies specifically to the subgroup WITHOUT known significant atherosclerosis. Entry criteria and the 36% MI reduction added.

### Cardiology 2026 #4 — Left Atrial Appendage Closure versus DOACs in Non-Valvular Atrial Fibrillation (CHAMPION-AF)

**matched with corrections**

Real and the summary is accurate — noninferior for efficacy, significant reduction in non-procedural bleeding. Presented at ACC.26 with simultaneous NEJM publication, 3,000 patients, NCT04394546. Added three things the original omitted: the actual numbers; the fact that the efficacy point estimate numerically favoured NOACs (ACC titled its coverage 'An Uneasy Win For Watchman Device', TCTMD 'A Win for Watchman FLX, but With Caveats'); and the contrast with CLOSURE-AF, without which a reader would draw the wrong general conclusion about LAAC. 'Updates electrophysiology guidelines' softened — no guideline revision confirmed.

### Cardiology 2026 #5 — LDL-C Target <55 versus <70 mg/dL with Ezetimibe Combination Therapy in Established ASCVD (Ez-PAVE)

**matched with corrections**

Real — NCT04626973, presented at ACC 2026 — and the 33% figure is correct. The trial name looked invented and is not. Added the design detail (ezetimibe combination therapy, 17 South Korean sites, 3,048 patients) and two material caveats the original omitted: the ACHIEVED LDL-C difference was only 56 vs 66 mg/dL, and the population was East Asian only. Medscape's coverage was headlined 'Does Ez-PAVE Support Lower Is Better for LDL-C?', so the entry no longer presents it as fully settled.

### Cardiology 2026 #6 — Aspirin versus Clopidogrel for Chronic Maintenance Monotherapy after PCI: 10-Year Follow-up of HOST-EXAM

**matched with corrections**

Real and accurately summarised. Same trial as entry 8 in the Anesthesiology 2026 list — a genuine cross-specialty overlap, not a duplication error. Two additions: all-cause mortality did not differ, which the original's 'maintains significantly lower rates' obscures; and 'Rewrote post-PCI chronic antithrombotic guidelines' is softened, since no guideline revision has been confirmed.

### Cardiology 2026 #7 — Ultrasound-Facilitated Catheter-Directed Fibrinolysis for Acute Intermediate-High-Risk Pulmonary Embolism (HI-PEITHO)

**matched with corrections**

Real and positive. NEJM DOI 10.1056/NEJMoa2516567, presented at ACC.26, 544 patients at 59 sites. One number removed: the original's '61% lower' composite reduction could not be confirmed from available sources, so the entry states the direction without the magnitude. Added the trial size and, importantly, that there was NO difference in bleeding — omitted from the original, and the crux of the risk-benefit argument.

### Cardiology 2026 #8 — IVUS versus Angiography Guidance for PCI in Complex Coronary Bifurcation Lesions (DKCRUSH VIII)

**matched with corrections**

Real and the findings are accurately described. JACC DOI 10.1016/j.jacc.2026.01.081, PMID 41914946, 556 patients, 24 Chinese centres, presented at ACC 2026. Two corrections: 'Reclassifies intravascular imaging-guided PCI as an ABSOLUTE REQUIREMENT' overstates — no guideline uses that language, and TCTMD's coverage was headlined 'Two Neutral IVUS Trials in Complex PCI - and One Positive - Spark Debate', which a reader needs to know. Also added that mortality and stent thrombosis did not differ, and the DK-crush-specific design.

### Cardiology 2026 #9 — Left Ventricular Unloading in Anterior STEMI Without Shock (STEMI Door-To-Unload)

**matched with corrections**

Real, and the original correctly reported this as a negative trial with increased vascular complications — the only entry across four submitted lists to state a negative result as negative. JACC DOI 10.1016/j.jacc.2026.03.071, 55 hospitals. Added the actual numbers, and in particular the 34% versus 6% bleeding and vascular complication rate, which is the most clinically important figure and was omitted. One correction: 'Promptly updated acute myocardial infarction guidelines to explicitly advise against' — no guideline update has been confirmed.

### Cardiology 2026 #10 — TRISCEND II: 2-Year Outcomes of Transcatheter Tricuspid Valve Replacement for Severe Tricuspid Regurgitation

**matched with corrections**

Real, presented at ACC.26 March 2026. The TR reduction and quality-of-life claims hold. Two corrections: the original credited the trial with reduced heart failure hospitalizations without qualification — that finding came from a crossover-inclusive analysis, and there was NO mortality benefit in the main analysis, which the entry now states plainly. And 'Upgrades transcatheter tricuspid interventions in valvular heart disease guidelines' could not be confirmed; no guideline revision has been identified.

### Dermatology 2025 #3 — Efficacy and Safety of Bimekizumab in Moderate-to-Severe Hidradenitis Suppurativa (BE HEARD I and BE HEARD II)

**corrected — year**

Real and accurately described. DATE: published in The Lancet on 22 May 2024, not 2025. Content otherwise unchanged; 'disease-modifying' softened to a description of the actual effect, since the trials measured clinical response rather than disease modification.

### Dermatology 2025 #4 — Nemolizumab with Concomitant Topical Therapy in Adolescents and Adults with Moderate-to-Severe Atopic Dermatitis (ARCADIA 1 and ARCADIA 2)

**corrected — year**

Real and accurately described. DATE: published in The Lancet on 24 July 2024, not 2025. One softening: 'Confirms IL-31 as the CENTRAL driver' overstates — the trials support IL-31 as a driver, and multiple cytokine pathways contribute to itch in AD. 'Rapid relief within days' changed to 'improves early', since the specific onset timing was not confirmed from the primary publication.

### Dermatology 2025 #5 — Rilzabrutinib in Antihistamine-Refractory Chronic Spontaneous Urticaria (RILECSU Phase 2)

**matched with corrections**

Real and accurate. JAMA Dermatology 2025;161(7):679-687, DOI 10.1001/jamadermatol.2025.0733, 160 patients, 51 centres. Two corrections: ANGIOEDEMA was not among the reported outcomes — the reported components are itch (ISS7) and hives (HSS7) within UAS7, so the angioedema claim has been removed. And the original's framing around 'autoimmune (type IIb) chronic urticaria' does not match enrolment, which was by omalizumab exposure rather than by type IIb status. Added the effective dose (1200 mg/day) and that this is a phase 2 dose-ranging study.

### Dermatology 2025 #6 — Lebrikizumab in Adults and Adolescents with Skin of Color and Moderate-to-Severe Atopic Dermatitis (ADmirable)

**corrected**

Real. Three corrections. The instrument is PDCA-Derm (Post-inflammatory hyperpigmentation/Dyspigmentation Clinical Assessment), not 'PCDA-Derm' as submitted — the letters were transposed. The study is OPEN-LABEL and single-arm with 90 patients, so 'Confirms high efficacy' overstates what an uncontrolled study can establish; the numbers are now given instead. And the pigmentary improvement was measured at week 24, so 'rapid reduction of dyspigmentation' is not supported.

### Dermatology 2025 #10 — Circulating Tumor DNA versus Merkel Cell Polyomavirus Antibodies for Surveillance of Merkel Cell Carcinoma Recurrence
...
### Orthopaedic Surgery 2025 #1 — Preoperative Gait Speed as a Predictor of Patient-Reported Outcomes After Total Hip Arthroplasty

**corrected — study design, publication year and the strength of the claim**

Real study, correctly identified. THREE CORRECTIONS. (1) Design: submitted as a 'prospective clinical study'; it is a retrospective cohort of 274 patients operated 2012-2018, Level III prognostic. (2) Date: published in JBJS on 4 March 2026, not 2025. (3) The submitted phrase 'the single most reliable predictor of long-term postoperative satisfaction' overstates it — the paper reports gait speed as a significant predictor among several preoperative variables (symptom duration, pain intensity, hip range of motion, muscle strength), and the outcome window is midterm, not long-term. Added the PASS cut-offs and the point that a prognostic association is not evidence prehabilitation works, which is how this result will be misused.

### Orthopaedic Surgery 2025 #3 — 2025 AAOS Clinical Practice Guideline: Management of Rotator Cuff Injuries

**corrected — the guideline is real, the described content was not its emphasis**

The guideline exists and the date is right: AAOS Board approved it in August 2025, replacing the 2019 version, with 21 recommendations and 8 options. CORRECTION TO CONTENT. The submission describes it as clarifying conservative care versus early repair and establishing 'treatment pathways based on tear etiology, patient age, tissue quality, and symptom duration'. That is not what the 2025 update is about — AAOS's own summary frames it around optimising the healing environment: biologics, bioinductive implants, retear reduction, acromioplasty and imaging. Rewritten to the recommendations that were actually published, since the submitted version would have a resident quoting decision criteria the guideline does not contain.

### Orthopaedic Surgery 2025 #5 — 2025 AAOS Clinical Practice Guideline Update: Management of Acute Compartment Syndrome

**corrected — real guideline, the scope of the update was overstated**

The 2025 update is real and the date is right (published 18 November 2025). CORRECTION. The submission claims it 'offers refined diagnostic parameters and surgical thresholds' and 'standardizes diagnostic protocols, continuous intracompartmental pressure monitoring criteria, and urgency timelines for surgical fasciotomy'. AAOS describes the opposite: a routine five-year review that 'received minor adjustments, primarily in the form of a single updated recommendation and the addition of supporting evidence', the single change being the Associated Fracture recommendation moving from Consensus to Limited. Rewritten to what changed, and the scope limits (adults only, not chronic exertional) added because both are stated explicitly in the guideline.

### Orthopaedic Surgery 2025 #6 — The "Quiet Knee" Rehabilitation Protocol After Primary Total Knee Arthroplasty

**corrected — design and one outcome that was not measured**

Real: HSS, presented at the AAHKS annual meeting and published as 'Quiet Knee Rehabilitation Protocol After Primary Total Knee Arthroplasty Is Associated With Lower Opioid Exposure and No Added Risks: A Retrospective Cohort Study'. The 25% opioid reduction is accurate and the MME figures are quoted from the paper. TWO CORRECTIONS. (1) Design: submitted as a 'clinical evaluation... demonstrated that shifting... significantly reduced'; it is retrospective and the paper's own title says 'associated with'. (2) The submission claims it 'significantly reduced surgical site inflammation' — oedema control is part of the protocol, not a measured outcome; the reported outcomes were opioid exposure, length of stay, pain, function and complications. That claim removed.

### Orthopaedic Surgery 2025 #7 — Surgery vs Functional Bracing for Closed Displaced Humeral Shaft Fractures (FISH)

**corrected — journal, year and the direction of the functional result**

The trial is real (FISH, Finnish Shaft of the Humerus, enrolled Nov 2012 to Jan 2018, 82 randomised). THREE CORRECTIONS. (1) Journal: published in JAMA, not The Journal of Bone and Joint Surgery. (2) Year: 2020, not 2025 — it does not belong to a 2025 review except as background. (3) DIRECTION: the submission claims surgery gave 'significantly superior short-term functional outcomes and faster return to activity at 3 months'. FISH did not show a clinically important functional advantage for surgery; its substantive finding is the 14 of 44 braced patients who needed secondary surgery and the worse outcomes in that crossover group. Rewritten around the healing and crossover data, which is the honest argument for early fixation. Also corrected 'multicenter study' to a two-centre randomised trial, and 82 patients stated so the reader knows how small it is.

### Orthopaedic Surgery 2025 #8 — An AI Care Aid for Perioperative Patient Questions in Joint Arthroplasty (HSS and Aidify)

**corrected — real pilot, the claimed benefits were not measured**

Real: HSS partnered with Aidify on a custom-tailored AI agent, presented at AAHKS and published in The Journal of Arthroplasty as 'Evaluating the Utility and Acceptability of an Artificial Intelligence-Powered Care Aid for Perioperative Patient Inquiries in Joint Arthroplasty Surgery'. TWO CORRECTIONS. (1) Scale and design: a prospective observational pilot of 40 patients (10 a priori plus 30), which the submission does not convey when it says the platform was 'validated'. (2) The submission's practical claim — 'reduces unnecessary emergency room visits and clinic calls while improving patient compliance' — was not an outcome of this study; the endpoints were usefulness, understandability, completeness and ease of access. Removed and replaced with what was measured. 'Triage' also removed: the study did not test triage.

### Orthopaedic Surgery 2025 #9 — Platelet-Rich Plasma as an Adjunct in Osteochondral Lesions of the Talus

**corrected — journal not confirmed, and the level of evidence was overstated**

A December 2025 systematic review does exist — 'The Role of Platelet-Rich Plasma in Treating Osteochondral Lesions of the Talus: A Systematic Review of Clinical and Preclinical Evidence', 35 studies (8 clinical, 27 preclinical), with 4 of 5 studies of PRP added to bone marrow stimulation reporting significant pain and function gains. TWO CORRECTIONS. (1) Journal: I could not confirm JBJS Reviews as the venue, so the journal field states the study type instead of naming a journal that may be wrong. (2) The submission says it 'establishes high-level evidence supporting biologic augmentation' and 'enhanced hyaline-like cartilage repair'. Eight mostly small non-randomised clinical studies is not high-level evidence, and the cartilage-quality claim rests on preclinical and proof-of-concept work. Rewritten to separate what the clinical studies showed from what the bench work suggests, and the leucocyte-rich versus leucocyte-poor variability added since it is a live confounder in this literature.

### Orthopaedic Surgery 2025 #10 — Prior Authorization Delays Total Hip Arthroplasty Without Reducing Cost

**corrected — one claimed finding is not in the study**

Real, presented at the 2025 AAOS Annual Meeting; the longer wait times and lower preoperative functional scores are accurate, and the headline finding — that prior authorization was not an effective cost-saving measure — was missing from the submission and has been added. CORRECTION: the submission asserts 'increased preoperative opioid use'. No opioid endpoint appears in this study; its patient-reported measures were HOOS-JR and SF-12 PCS. That claim has been removed and the entry says explicitly that it cannot be supported, because it is the kind of plausible detail that gets repeated once written down. Also corrected 'multi-institutional': the study describes a single commercial payor cohort.

### Orthopaedic Surgery 2026 #1 — ACL Reconstruction in Patients Over 50: Age Alone Is Not a Contraindication

**corrected — no comparison group, so the equivalence claim is not supported**

Real, presented at the 2026 AAOS Annual Meeting in New Orleans, and the numbers are accurate (83.9% very good/excellent, 91.5% expectations met, 88.2% acceptable symptom state, 7.1% graft failure, mean follow-up just over six years). CORRECTION: the submission says over-50s 'experience identical functional gains and graft survival rates from ACL reconstruction as younger demographics'. This was a single-cohort series with no younger control arm — 'identical to younger patients' is not a finding it can produce. The AAOS report itself cautions that the results likely reflect appropriately selected, physiologically young patients and that longer follow-up is needed. Rewritten to the outcomes actually reported, with the selection caveat kept in the practical field where a reader will see it.

### Orthopaedic Surgery 2026 #2 — 2026 AAOS Clinical Practice Guideline: Management of Ankle Osteoarthritis

**corrected — the guideline is real, its central claimed content is not in it**

The guideline is real and the date is right (published 2 July 2026; the first AAOS CPG covering non-operative and operative ankle OA). MAJOR CORRECTION. The submission's substance is that it 'delivers clear evidence-based decision trees contrasting total ankle arthroplasty (TAA) against tibiotalar arthrodesis (fusion), giving TAA stronger recommendation grades for patient-reported mobility'. AAOS's own release says the guideline contains only two recommendations — intra-articular hyaluronic acid and intra-articular PRP — plus twelve options, and that research gaps prevented clear treatment guidance. There is no TAA-versus-fusion recommendation to cite, and the submitted 'standardizes surgical referral criteria and post-operative weight-bearing protocols' is likewise absent. Rewritten to what the guideline says, including the 70-80% post-traumatic figure, and the practical field warns against exactly the misattribution the submission would have created.

### Orthopaedic Surgery 2026 #3 — Subvastus Muscle-Sparing Approach in Robotic Total Knee Arthroplasty

**corrected — adoption and the discharge claim overstated**

The mechanism and the comparative data are real: a randomised-trial meta-analysis favours subvastus and quadriceps-sparing approaches over standard parapatellar on pain, range of motion, straight leg raise and lateral retinacular release, and there is a robot-assisted subvastus series of 81 patients / 120 knees with 85% active straight leg raise by day 2. TWO CORRECTIONS. (1) 'Widespread adoption... has reshaped primary total knee replacement' is not supported — the robotic subvastus evidence is single-surgeon series, not registry-scale practice change. (2) The submission claims 'higher rates of same-day discharge'; the series it would rest on reported a mean length of stay of 3.4 days. Rewritten to the measured quadriceps outcomes, with the length-of-stay figure stated so the discharge claim cannot be repeated from this entry. Learning curve added — it is the reason the approach is not universal.

### Orthopaedic Surgery 2026 #4 — GLP-1 Receptor Agonists in Preoperative Arthroplasty Optimisation

**matched with corrections — direction confirmed, three counter-findings added**

Verified and, if anything, better supported than submitted: the perioperative infection, revision and readmission benefits are real with the effect sizes quoted, the morbid obesity subgroup figures check out, and the perioperative holding protocol for aspiration risk is accurate. Nothing was reversed. THREE ADDITIONS the submission omitted, all of which change the counselling: the reported one-year increase in periprosthetic fracture risk (OR 1.49, mainly TKA), the high prevalence of malnutrition in GLP-1 users presenting for arthroplasty, and the JBJS finding of no mid-term benefit. An entry that gives only the benefits would have a resident recommending these drugs preoperatively without mentioning the fracture signal.

### Orthopaedic Surgery 2026 #5 — Sensor-Enabled "Smart" Knee Implants and Remote Therapeutic Monitoring

**corrected — two capabilities described do not exist in the device**

The technology and the outcome are real: Persona IQ with the canturio tibial extension (Canary Medical), FDA market release authorisation 30 August 2021, reporting through the CHIRP system, with manipulation under anaesthesia at 0.97% versus 3.10% for conventional implants. TWO CORRECTIONS, both clinically material. (1) The submission lists 'localized thermal changes' among the tracked metrics — the implant contains an inertial measurement unit (gyroscope and accelerometer) and measures kinematics; there is no temperature sensor. (2) It follows that 'clinicians can remotely identify... infection weeks before symptoms manifest' is not a capability of this device; the manufacturer's indication is objective kinematic data as an adjunct. Both removed, with the stiffness/manipulation use case — which is what the data actually show — put in their place. Also corrected the timing: this is not something that 'entered broad clinical usage' in 2026; it has been FDA-authorised since 2021.

### Orthopaedic Surgery 2026 #6 — Bioresorbable Magnesium Alloy Implants in Orthopaedic Trauma

**corrected — clinical maturity and the resorption timeline overstated**

The direction is real: magnesium alloy implants resorb, avoid removal surgery, have an elastic modulus near bone, and the osteoinductive effect of released magnesium ions is supported. TWO CORRECTIONS. (1) The submission describes 'clinical expansion' as if the technology were settled; the reviews are explicit that unpredictable in vivo degradation, high corrosion rates, unexplained radiolucent zones, limited long-term safety data, absent standardised testing and regulatory uncertainty are the main barriers to wider use. Those barriers are now in the entry, because a resident told only the upside would not know why they never see one. (2) 'Fully resorbs into the body over 12 to 24 months' — I could not verify that as a general figure and degradation rate is precisely what is not yet predictable, so it has been removed rather than quoted. The submission's coupling of magnesium with 'printed osteoconductive scaffolds' for soft-tissue anchors is a separate and less mature technology; the entry no longer treats them as one development.

### Orthopaedic Surgery 2026 #8 — AI-Assisted Preoperative Planning and Implant Templating in Arthroplasty

**corrected — narrowed to remove a duplicate, and no validation study resolved**

Rewritten in two ways. (1) DEDUPLICATED: as submitted this entry covered both AI surgical planning and patient-facing triage chatbots, and the chatbot half duplicates the 2025 entry on the HSS and Aidify care aid — which is the one with actual data behind it. Under the same rule applied to neurosurgery, obstetrics and neurology, a development appears under one year only, so the chatbot content stays on 2025 and this entry is now planning-only. (2) The planning capability is real and deploying, but I could not resolve a specific multicentre validation study, so no trial or effect size is asserted. The submission's 'broad implementation... across major health networks' is not evidenced and has been replaced with what the reviews support, plus the point that these tools are validated against surgeon agreement rather than patient outcomes.

### Orthopaedic Surgery 2026 #9 — The "Bikini" Incision in Direct Anterior Total Hip Arthroplasty
...
**matched with corrections — two named requirements not confirmed**

Verified: the 2025 CAP Laboratory Accreditation Program checklist edition does expand digital pathology (new use cases, image and data quality factors, validation or verification of systems including at remote sites, digital pathology brought into Laboratory General) and does add a new Phase II requirement for patient self-collected specimens requiring written instructions. TWO CORRECTIONS. The submission lists 'AI image analysis validation' and 'color calibration' as things the checklist establishes standards for; neither was confirmed as a checklist requirement in this edition, so they are not asserted — CAP's AI validation guidance is a separate and still-forthcoming document (see the AI entry). The verified requirements are quoted instead, which are more useful anyway because they are the ones an inspector will ask about. The submitted url was retained since it resolves to the CAP newsroom item.

### Pathology 2025 #2 — CAP Guidance on Validating Machine Learning in Pathology: A Concept Paper and a Guideline Still Coming

**corrected — the guideline described has not been published yet**

The work is real but not at the stage submitted. The submission says 'The CAP Artificial Intelligence Committee introduced comprehensive clinical recommendations governing the complete machine learning lifecycle' and that it 'Mandates local site-specific validation for all commercial and FDA-approved AI diagnostic tools'. What exists is a 2024 CAP CONCEPT PAPER in Archives of Pathology & Laboratory Medicine plus a full guide that CAP TODAY reports the AI Committee will SUBMIT in 2026 — so as of this list there is no published CAP AI guideline and nothing is mandated. The reporting is explicit that no formal guidelines currently exist for verification and validation of these systems. Rewritten to say that plainly. The substance of the submission's advice — local validation even for FDA-cleared vendor tools, monitoring for drift and bias, pathologist confirmation of AI-assisted grading — is accurate as the committee's stated interim position and is kept, correctly labelled as such rather than as a mandate.

### Pathology 2025 #3 — Multi-Tissue Cancer Detection Foundation Models Reach FDA Breakthrough Designation

**corrected — regulatory status and one product conflated with another**

The 40-plus tissue type claim is real and correctly attributed to Paige: Breakthrough Device Designation April 2025, the first for a multitissue AI assist, expanded from 17 to over 40 tissue types, internally validated on 21 biopsy and 25 resection types, built on the Virchow foundation model. THREE CORRECTIONS. (1) The submission presents 'Paige PanCancer Detect and Ibex Galen platforms' as jointly covering 40+ tissue types; Ibex's FDA-cleared product is Prostate Detect (Galen Second Read, 510(k) February 2025), a single-organ second read. (2) Breakthrough Device Designation is not clearance or approval and is not evidence of performance — the submission's 'clinical validation... expanded automated cancer detection' and 'Validates AI as an automated secondary reader' both overstate it, and the validation described is internal. (3) 'Dramatically decreases diagnostic turnaround times... and reduces diagnostic error rates in high-volume biopsy subspecialties' has not been demonstrated and is removed.

### Pathology 2025 #4 — Predicting Genomic Alterations Directly from H&E Slides

**matched with corrections — supported, with performance quantified**

Verified. Deep learning prediction of MSI and HRD from routine H&E is real and published in strong venues, including DeepHRD in the Journal of Clinical Oncology with comparison against four standard HRD molecular tests in platinum-treated clinical cohorts, and DeepSMILE for MSI and HRD in colorectal and breast cancer. ONE CORRECTION of degree: the submission says these models 'can accurately predict underlying genomic alterations'. The reported AUC for HRD from held-out breast slides is 0.81, which supports triage but not accuracy sufficient to replace sequencing — added, because the submission's 'accelerates precision oncology treatment selection by identifying candidates for targeted therapy weeks before... NGS results return' invites using the prediction as the decision. The entry now states explicitly that it must not be used to withhold PARP inhibitor or platinum therapy. The submission's targetable-mutation claim is broader than what I could verify; MSI and HRD are named instead.

### Pathology 2025 #5 — Multi-Cancer Early Detection: Real-World Performance and the Sensitivity Problem

**corrected — the decisive number was missing and no guideline endorses these tests**

The studies are real and large: 111,080-person real-world series in Nature Communications 2025 (0.91% detection rate, 49.4% empirical positive predictive value, 87% signal-origin accuracy), the CCGA validation in Annals of Oncology (51.5% sensitivity across 50+ cancers, 99.5% specificity), and the prospective PATHFINDER study. TWO CORRECTIONS. (1) THE OMISSION IS THE PROBLEM. The submission says these studies 'validated blood-based cfDNA methylation... assays for detecting early-stage cancers' without any sensitivity figure. Prospective sensitivity in an asymptomatic population was 28.9% — the single most important number for a clinician, because it determines that a negative result is nearly uninformative. Added, with an explicit statement that MCED must not displace established screening. (2) 'Refines guidelines for non-invasive cancer screening' — no guideline recommends MCED for screening; that is stated. The submission's 'spectroscopic liquid biopsy' assays are a separate and much earlier-stage research area and are not asserted as validated alongside the methylation assays.

### Pathology 2025 #6 — In-House Rapid NGS versus Send-Out Molecular Profiling in Solid Tumours

**matched with corrections — supported, with the investment cost restored**

Verified and quantified. Send-out turnaround of roughly three weeks (9-30 days) against 3 days in-house, a median of three business days over 578 solid tumour samples, a 10-day average reduction, a modelled $1,022,446 five-year return with a 15-month payback, and a 3.38% increase in patients on targeted therapy — all confirmed and added, since the submission asserted superiority without figures. TWO CORRECTIONS. (1) The submission says in-house testing 'significantly outperforms outsourced laboratory send-outs in clinical decision speed and overall cost-efficiency'. The speed finding is solid; on cost, the sources are explicit that investment costs of establishing in-house NGS are substantial and the saving is a longer-term modelled result — that qualifier is now in the entry, because a resident quoting cost-efficiency to an administrator will be asked about capital. (2) The budget impact analysis was specific to metastatic NSCLC rather than pan-cancer as the submission implies; noted.

### Pathology 2025 #7 — Cryptic PML::RARA in Acute Promyelocytic Leukaemia: When RT-PCR Is Negative and Morphology Is Not

**corrected — the recommended assay has the same blind spot as the one it was meant to fix**

The clinical problem is real and well documented: cryptic APL in under 1% of cases, present with all three isoforms, escaping routine qRT-PCR, with resolution by RNA sequencing, optical genome mapping or rapid NGS. TWO CORRECTIONS. (1) TECHNICAL, and it matters. The submission recommends anchored multiplex PCR NGS as the answer to fusions 'missed by traditional RT-PCR and amplicon assays'. Anchored multiplex PCR is itself a TARGETED assay: the sources state that qRT-PCR, targeted RNA sequencing and anchored multiplex PCR are all highly effective for low-abundance transcripts of known fusions but that novel or uncharacterised events may be overlooked by these targeted assays. Naming AMP as the escalation would leave a resident with a false sense of coverage; the entry now names unbiased RNA sequencing and optical genome mapping. The submission's own guideline statement — broad RNA-based sequencing when suspicion is high despite negative targeted RT-PCR — was right, and is kept. (2) Journal: I could not confirm Archives of Pathology & Laboratory Medicine as the venue, so it is not named. Added the point about starting ATRA on suspicion, since the delay this entry is about is a bleeding-death delay.

### Pathology 2025 #10 — Drone Transport of Laboratory Specimens Between Hospital Sites

**corrected — scope overstated and a regulatory claim not supported**

Real and unusually well documented: Northwestern Medicine Delnor with Valqari, 303 packages at a 100% success rate with no damage or temperature fluctuation, a half-mile round trip taking about 30 minutes on foot versus 4 minutes by drone and walked over 40 times a month, benefit to same-day blood product transfusion, and no cameras on the drones. THREE CORRECTIONS. (1) The submission says 'Major academic medical systems (such as Northwestern Medicine) completed pilot programs' — it is one hospital within one system, and Delnor is described as among the first in the US, so the plural overstates adoption. (2) 'Intra-hospital' and 'intra-facility' are wrong: this is INTER-site transport between campuses over a half-mile route, which is a different logistics problem from moving a frozen section within a building — and the submission's headline benefit of 'accelerating intraoperative pathology consults' does not follow from it. (3) 'Defines cold-chain, temperature-monitoring, and biosecurity protocols for airborne medical logistics under CAP and FAA regulatory frameworks' was not supported; CAP TODAY discusses privacy, cost and safety, but no CAP protocol was defined. Removed, and the privacy design substituted since it is the concrete transferable lesson.

### Pathology 2026 #1 — 2026 CAP/ADASP Guideline: Interpretive Diagnostic Error Reduction in Surgical Pathology and Cytology

**corrected — real guideline, the specific requirements described are not in it**

The guideline is real, jointly sponsored by CAP and ADASP, and is a 2026 update of the 2016 'Interpretive Diagnostic Error Reduction in Surgical Pathology and Cytology' guideline. CORRECTION TO CONTENT. The submission says it 'Formally requires pathology departments to establish mandatory secondary review workflows for complex cases (e.g., first-time cancer diagnoses, high-grade dysplasias) prior to sign-out, as well as systematic peer-review tracking'. The guideline's published content is two strong recommendations on moderate-certainty evidence — establish formal case-review procedures to identify diagnostic disagreements and potential interpretive errors, and complete those reviews quickly enough to positively influence patient management. It does not specify mandatory pre-sign-out secondary review of the named case categories, and a resident citing that requirement would be citing something that is not there. Rewritten to the actual recommendations, with the timeliness element foregrounded because it is the substantive addition and the submission missed it entirely.

### Pathology 2026 #2 — 2024 McDonald Criteria: Kappa Free Light Chains Accepted Interchangeably with Oligoclonal Bands

**corrected — year of the criteria, and 'replace' is too strong**

Real and correctly identified in substance: the McDonald revisions do accept CSF kappa free light chain testing alongside oligoclonal bands, with equivalent sensitivity and specificity at the 95% confidence level, a κ-FLC index cut-off of ≥6.1 performing best, and the practical advantages of an automated, cost-effective, rater-independent platform. TWO CORRECTIONS. (1) These are the 2024 REVISIONS, published in 2025 and presented at ECTRIMS — not '2026 McDonald Criteria Updates' as submitted. Getting the edition right matters because clinicians look these criteria up by year. (2) The submission says κ-FLC 'formally replace' oligoclonal band detection via isoelectric focusing. The revisions make them INTERCHANGEABLE; concordance is around 90% and the sources advise determining both in rare cases. A laboratory that read 'replace' and decommissioned its isoelectric focusing capability would have acted on the wrong word, so the distinction is stated explicitly.

### Pathology 2026 #3 — Pathology AI Is Regulated as Software-as-an-IVD, Not as Software-as-a-Medical-Device

**matched with corrections — supported, with one framing precision**

Supported. Digital pathology tools supporting generation of patient results are IVD medical devices; the pathology review office's framing treats the algorithm as a component of a diagnostic assay rather than standalone image-reading software, in explicit contrast with radiology; and post-market attention falls on analytical drift, assay-level adverse events and lot-traceable corrections. The submission's substance and its implication — specimen-aware validation across stains, scanners, fixatives and lab protocols — both hold. ONE CORRECTION of framing: this is a regulatory paradigm evident in how the office reviews these products, not a formal 2026 reclassification announcement, and the entry no longer implies a discrete rulemaking event. ADDED: through April 2026, 51 AI/ML-flagged authorisations in pathology-relevant panels of which only seven analyse whole-slide images — a reality check absent from the submission and the figure most likely to correct an inflated impression of how much cleared pathology AI exists.

### Pathology 2026 #4 — The Pathologist as Integrator of Morphology, Molecular and Computational Data

**corrected — the concept is real, the attribution and the standards claim are not**

The concept is well supported in the 2026 literature: the pathologist as central integrator of morphologic, molecular and computational outputs, with spatial transcriptomics, spatial proteomics and multiplexed imaging adding a spatial dimension aligned with routine architectural assessment, supporting molecular subtyping, prognostic stratification and therapy-response prediction. TWO CORRECTIONS. (1) ATTRIBUTION: the submission credits the Digital Pathology Association and 'informatics leadership' with having 'formalized the "Pathologist as Integrator" framework'. I could not confirm a named DPA framework; the framing appears across reviews rather than as one body's published document, and the entry says so. (2) 'Updates laboratory information system (LIS) and image management system (IMS) interoperability standards, driving synchronized reporting across pathology, radiology, and medical genetics' — no such standards update was found, and it has been removed rather than softened, because it would have a resident believing an interoperability requirement exists. Added that most spatial platforms remain research-use, which bounds the claim.

### Pathology 2026 #6 — Rapid Whole-Genome Sequencing for Critically Ill Infants

**matched with corrections — supported, with real-world turnaround restored**

Verified and quantified. Actionable findings in 24-72 hours in the fastest programmes with a 77-90% reduction in time to diagnosis, diagnostic yields of 32-39%, 43% (against 10% for standard methods) and 57%, and management change in 52% and up to 87% depending on setting — all confirmed and added, since the submission asserted turnaround and utility without numbers. ONE CORRECTION: the submission states that adoption 'cut molecular diagnostic turnaround times to under 24-48 hours for critically ill infants' as a general fact. Published real-world medians are considerably longer — 13 days in a 100-infant study, 169 hours in a pilot — so the entry separates what a mature pipeline achieves from what published cohorts typically report, and names the reason for the gap. A resident promising a 24-hour result on the basis of the submitted version would be promising the best case as the norm.

### Pathology 2026 #8 — Automated Digital Cell Morphology in Peripheral Blood and Bone Marrow

**corrected — the headline figure was not verified and a key limitation was omitted**

The direction is supported: digital morphology analysers are established for peripheral blood, AI-assisted digital cytomorphology has extended to bone marrow, Morphogo reported 95.4% of classified cells correctly classified, and a 2024 multicentre trial of the Scopio platform showed high concordance with manual microscopy plus better standardisation, sensitivity and workflow efficiency. TWO CORRECTIONS. (1) FIGURE NOT VERIFIED: the submission claims these systems 'reduce manual microscopic blood smear review rates by over 60%'. I could not confirm that figure and it is not asserted; the reproducibility gain from counting far more cells is substituted, which is the benefit the literature does support. (2) OMITTED LIMITATION: certain neoplastic bone marrow cells are notably challenging for automated digital morphology and this can significantly affect cytomorphological diagnosis. The submission's conclusion — that hematopathologists can 'focus exclusively on difficult or abnormal cases' — reads as though the automation is reliable on abnormal marrows, which is the opposite of the reported weakness. Added, with the recommendation to validate on dysplastic and blastic cases rather than normal marrows.

### Pathology 2026 #9 — Clinical Decision Support for Laboratory Utilisation Management

**matched with corrections — supported, evidence base characterised accurately**

The direction is well supported: EHR-embedded decision support, frequency rules, best practice advisories, removal of pre-checked labs from order sets, and dashboards tracking volumes, tests per admission-day, cost savings and balancing measures. ADDED, and it is the most useful thing here: the ELMO cluster randomised trial found decision support improved appropriateness of laboratory ordering in primary care without increasing diagnostic error, which is the direct answer to the objection that stewardship causes missed diagnoses. TWO CORRECTIONS. (1) The submission says 'Major academic medical centers published multi-year outcomes demonstrating' the effect; what I found is a pre-implementation study, quality-improvement programme reports and one primary care cluster randomised trial — the entry characterises the evidence accordingly rather than implying long-run academic outcome data. (2) 'Reduces diagnostic phlebotomy-induced anemia in long-stay patients' is a plausible mechanism but was not a demonstrated outcome of these interventions, and is not asserted as one.

### Pediatrics 2025 #1 — AAP/NASPGHAN Clinical Practice Guideline: Diagnosis and Management of Faltering Weight

**corrected — the diagnostic thresholds given were from a different classification system**

The guideline is real and correctly identified: first joint AAP/NASPGHAN CPG, GRADE, panel 2021-2024, Pediatrics 2026;157(4):e2025075764, and it does replace 'failure to thrive' with 'faltering weight' and move from percentiles to z-scores. THE THRESHOLDS ARE WRONG. The submission gives severity bands of mild −1 to −1.9, moderate −2 to −2.9, severe ≤−3. Those are the ASPEN/Academy of Nutrition and Dietetics paediatric MALNUTRITION severity indicators, not this guideline's diagnostic criteria. The guideline's criteria are: weight-for-length or BMI-for-age < −1.65 z; or, under age 2, weight-gain velocity < −2 z; or a decline of ≥1 z-score. A resident applying the submitted bands would use the wrong cut-off in both directions — waiting for −2 before diagnosing, when a 1 z-score decline already qualifies. Corrected, with the one-z-score point moved into the impact field because it is the substantive change and the submission missed it. Date corrected: 2026, not 2025.

### Pediatrics 2025 #4 — Nirsevimab Effectiveness Against RSV ICU Admission and Acute Respiratory Failure

**matched with corrections — supported, with waning added**

Verified and accurate as submitted: 80% against RSV-associated ICU admission and 83% against acute respiratory failure, from a prospective 27-hospital case-control investigation across 24 states, December 2024 to April 2025. IMPORTANT ADDITION: effectiveness fell from 86% at 7-59 days to 66% at 60-183 days after administration. The submission presents a single flat figure, which would have a clinician assume uniform season-long protection; the waning is what determines dosing timing and belongs in the entry. Also added that most infants were previously healthy, since that is what distinguishes this from the palivizumab era, and the operational definition of acute respiratory failure so the 83% is interpretable.

### Pediatrics 2025 #5 — Whole-Body Hypothermia in Preterm Infants 33 to 35 Weeks with Neonatal Encephalopathy

**matched with corrections — the result is stronger than submitted**

Verified: NICHD Neonatal Research Network randomised trial, 19 centres, July 2015 to December 2022, infants 33-35 weeks with moderate or severe HIE cooled at under 6 hours, no reduction in death or disability at 18-22 months. The submission is correct as far as it goes but UNDERSTATES the finding. It says cooling 'did not reduce the primary outcome' and mentions 'potential adverse event risks'. The actual data point towards harm: 35% versus 29% for death or disability, 20% versus 12% for death, and a Bayesian analysis giving 74% probability of increased death or disability and 87% probability of increased death. Those figures have been added, because 'no benefit' and 'probably harmful' support different conversations with a family and different institutional policy. The submission's practical conclusion — restrict cooling to ≥36 weeks and avoid off-label use — is right and is kept.

### Pediatrics 2025 #6 — Characterizing Long COVID in Children and Adolescents (RECOVER-Pediatrics)

**corrected — two studies were merged into one, and the cluster findings were missing**

Real: RECOVER-Pediatrics, JAMA, published 21 August 2024, over 5,300 participants at more than 60 institutions. TWO CORRECTIONS. (1) The submission describes one study identifying clusters 'across developmental stages, highlighting distinct presentations in infants/toddlers versus older children and teens'. The JAMA cohort paper covers school-age children and adolescents; the infant and toddler patterns are a SEPARATE later RECOVER analysis. Merging them attributes findings to a paper that does not contain them. (2) The actual structure — four clusters in school-age children, three in adolescents — was absent from the submission, along with the symptom lists, which are the usable content. Both added. Date corrected to 2024. The submission's example symptoms ('post-exertional malaise and dysautonomia in teens') are plausible but were not among the most predictive symptoms reported, so the published lists are used instead.

### Pediatrics 2025 #7 — Fluoride Exposure and Children's IQ Scores: Systematic Review and Meta-Analysis

**matched with corrections — supported, with the contested context restored**

Verified: JAMA Pediatrics January 2025, 74 studies from 1989-2023, inverse association, effect estimate of −1.63 IQ points per 1 mg/L urinary fluoride in the 13 individual-level studies, association persisting below 1.5 mg/L in high-quality evidence. THREE ADDITIONS, all of which change how a pediatrician should use this. 52 of the 74 studies were rated high risk of bias and only 22 high quality. The studies were done in 10 countries and NONE in the United States, at exposures generally well above the 0.7 mg/L of US community fluoridation. And the paper drew a substantial published critique, including a JAMA Pediatrics editorial counselling caution — a clinician quoting the headline as settled will be met with it. ONE CORRECTION: the submission says the study 'prompted public health and pediatric dental organizations to re-examine total daily fluoride thresholds'. I could not confirm an organisational threshold review, so it is not asserted; the practical advice about totalling systemic exposure while continuing topical fluoride is sound and is kept.

### Pediatrics 2025 #8 — Residual Exacerbations on Mepolizumab in Urban Children with Asthma (MUPPITS-2)

**corrected — the mechanism is not the clean non-type-2 story submitted**

Real work, correctly identified: MUPPITS-2 in The Lancet (2022, 27% relative reduction in severe exacerbations, autumn-predominant) with the nasal transcriptomic analysis in Nature Communications (2025, PMID 40897727). CORRECTION TO MECHANISM. The submission says breakthrough exacerbations 'were driven by non-Type 2 inflammatory pathways (specifically epithelial hypersecretion and viral macrophage responses)'. The published finding is subtler and partly the opposite: mepolizumab dissolved eosinophil gene correlation but CONSERVED and sometimes strengthened correlation among mast-cell genes, type 2 cytokines and epithelial inflammatory genes, and a separate JACI analysis found activated sputum eosinophils still associated with exacerbations. So residual type 2 activity persists rather than being replaced by a purely non-T2 process. The specific pathways named in the submission were not confirmed and are not asserted. The submission's clinical conclusion — keep controller therapy, do not rely on the biologic alone — is right and is kept, with the 27% figure added so the magnitude is visible.

### Pediatrics 2025 #9 — Exagamglogene Autotemcel: Long-Term Outcomes in Sickle Cell Disease and Beta-Thalassemia

**corrected — presented as a paediatric result from a mostly adult cohort**

The efficacy data are real and if anything stronger than submitted: CLIMB SCD-121 final results show 45 of 45 evaluable patients crisis-free and hospitalisation-free at a median 41.3 months' follow-up, mean crisis-free duration 35.3 months, with durable benefit beyond 5 years across both indications. THREE CORRECTIONS. (1) POPULATION: the submission describes outcomes 'in pediatric patients'. The cohort was 12 adolescents and 34 adults, mean age 21.4 years, and the label at the time covered ages 12 and over — this is not a young-children result, which is the separate 2026 trial. (2) The submission merges vaso-occlusive crisis freedom and transfusion independence into one finding; they are endpoints of two different trials in two different diseases. (3) 'Restructured pediatric hematology guidelines to position autologous gene therapy as a curative therapeutic pathway' overstates what was confirmed; the durable-benefit data and the removal of the donor requirement are stated instead, with busulfan conditioning, infertility risk and centre requirements named because the submission mentions conditioning only in passing.

### Pediatrics 2025 #10 — Closing the Evidence Gap for Drugs in Children: Strengthening the Pediatric Research Equity Act

**corrected — proposals described as accomplished policy, and the figures were missing**

Real: NEJM Perspective, NEJMp2518278, PMID 42012006, published April 2026 (not 2025 — the date is corrected in the field but the entry is left on the submitted year, as with other out-of-year citations in this project). TWO CORRECTIONS. (1) The submission says the piece 'Accelerated FDA and international regulatory initiatives REQUIRING sponsors to initiate Phase 3 pediatric trials prior to adult product approval and remove orphan-drug exemptions'. Those are proposals — the Innovation in Pediatric Drugs Act among them — not enacted requirements, and a resident citing them as current regulation would be wrong. Reworded. (2) The substance was absent: 28% of required trials completed, over 700 deadline extensions, 250 studies delayed, and rare-disease designation exempting nearly half of new drugs. Those figures are the argument and have been added.

### Pediatrics 2026 #1 — Zorevunersen in Children and Adolescents with Dravet Syndrome

**corrected — trial phase, and the seizure figure was the best interval rather than the result**

Real and correctly identified: NEJMoa2506295, PMID 41780062, zorevunersen targeting SCN1A haploinsufficiency to up-regulate NaV1.1. THREE CORRECTIONS. (1) PHASE: the submission implies a definitive trial. These are two phase 1-2a OPEN-LABEL studies (MONARCH and ADMIRAL) plus extensions, 81 patients enrolled, 75 continuing — no control group, so the effect size cannot be separated from natural history and concomitant therapy. (2) The submission quotes 'up to a 91% reduction in monthly seizure frequency'. The reported result is a median change ranging from −58.82% to −90.91% across one-month intervals; citing only the ceiling is the most favourable possible reading. Range given instead. (3) 'Disease-modifying' is softened to potential, which is the paper's own wording. The submission's practical point about serial lumbar punctures is right and kept; monitoring of CSF protein specifically could not be confirmed and is not asserted.

### Pediatrics 2026 #2 — Routine Gastric Residual Volume Measurement in Critically Ill Children (GASTRIC-PICU)

**matched with corrections — supported, design and effect size clarified**

Verified: JAMA, 23 PICUs across the UK, Scotland, Northern Ireland and Switzerland, 4,700 children aged 0-16, June 2023 to December 2025, non-inferiority open-label design, no routine GRV non-inferior for survival and ventilator-free days at 30 days (median 25 days both groups), energy targets 80.3% versus 76.8% at 72 hours. TWO CORRECTIONS. (1) The submission says omission 'resulted in earlier delivery of target enteral nutrition with no increase in ventilator-associated pneumonia (VAP) or aspiration events'. The measured nutritional difference is 3.5 percentage points of energy target by 72 hours — real but not the substantial acceleration implied — and VAP and aspiration as specifically reported outcomes could not be confirmed, so they are not asserted; the confirmed primary outcome is stated instead. (2) The non-inferiority design was missing and matters: this shows nothing is lost, not that outcomes improve. Trial size added, since 4,700 children is the reason this settles the question.

### Pediatrics 2026 #3 — Fremanezumab for Preventive Treatment of Episodic Migraine in Children and Adolescents (SPACE)

**matched with corrections — drug class mislabelled, details added**

Verified: SPACE, randomised double-blind placebo-controlled phase 3, 237 patients aged 6-17, fremanezumab 120 mg and 220 mg monthly, published in NEJM online 14 January 2026, first phase 3 evidence for an anti-CGRP monoclonal antibody in children, safety consistent with adults. TWO CORRECTIONS. (1) TERMINOLOGY: the submission's guideline-impact line says the trial 'Established CGRP antagonists as a recommended, evidence-based preventive class'. Fremanezumab is a monoclonal antibody against CGRP, not a CGRP receptor antagonist — the gepants are the antagonists and were not studied here. Conflating them would have a clinician reach for the wrong drug. (2) The submission presents guideline incorporation as the regulatory consequence; what is confirmed is that the FDA had already expanded the paediatric indication based on earlier SPACE data, which is the stronger and more actionable fact. Added n, ages and doses, and the CHAMP context that explains why this gap existed.

### Pediatrics 2026 #4 — Two-Year Crinecerfont Data in Pediatric Classic Congenital Adrenal Hyperplasia (CAHtalyst Pediatric)

**corrected — one figure unverified and the evidence status overstated**

Real: two-year open-label extension data from the phase 3 CAHtalyst Pediatric study, 86 participants aged 4-17, durable ACTH and 17-OHP reductions with lower glucocorticoid doses, presented at the Pediatric Endocrine Society 2026 annual meeting with growth measures at ENDO 2026. THREE CORRECTIONS. (1) FIGURE NOT VERIFIED: the submission states a mean reduction of 3.2 mg/m²/day in glucocorticoid dosing. I could not confirm that number and it is not asserted; the confirmed finding is a sustained reduction to more physiologic dosing. (2) These are conference presentations, not a peer-reviewed two-year publication — the submission reads as though it were the latter. (3) 'Prompts major updates to pediatric endocrine society guidelines' could not be confirmed; FDA approval of crinecerfont is the verifiable anchor. The submission's list of downstream benefits (BMI, growth, metabolic risk, bone health) is mechanistically reasonable and growth measures were presented, but the full list was not all demonstrated at two years and is now framed accordingly.

### Pediatrics 2026 #7 — Exa-cel Gene Editing in Children Aged 5 to 11 with Sickle Cell Disease or Beta-Thalassemia

**matched with corrections — supported, and the label expansion goes further than stated**

Verified: NEJMoa2603387, PMID 42274009, published online 10 June 2026; CLIMB THAL-141 and CLIMB SCD-151 in children aged 5-11; all patients with sufficient follow-up met the primary endpoint, with no transfusions after the 60-day washout in thalassaemia and no vaso-occlusive crises in sickle cell disease; haemoglobin normalised; safety consistent with prior studies. TWO ADDITIONS. (1) The FDA has expanded approval to children aged 2 and over — a wider expansion than the 5-to-11 cohort studied, and the most consequential fact in the entry, which the submission omits entirely. (2) Busulfan-related veno-occlusive disease is named as the specific recognised risk; the submission refers to conditioning generically. The submission's points about referral before irreversible end-organ damage and about fertility preservation are sound and are kept. Kept as a separate entry from the 2025 long-term follow-up entry because this is a different age cohort in different trials that drove a label change, on the same basis as the OTOF durability entry in otolaryngology.

### Pediatrics 2026 #8 — CONSORT-C 2026 and SPIRIT-C 2026: Reporting Standards for Paediatric Trials

**matched with corrections — supported, one journal and the youth role added**

Verified: SPIRIT-C 2026 and CONSORT-C 2026 co-published February 2026, led at SickKids by Ami Baba and Martin Offringa with 38 international experts, covering age-appropriate outcomes and intervention delivery, consent and assent, family involvement and developmental needs. THREE ADDITIONS. (1) Co-publication includes JAMA Pediatrics as well as The BMJ and The Lancet Child & Adolescent Health; the submission names only two. (2) The item counts — 17 new SPIRIT-C items, 13 new CONSORT-C items — give the reader a sense of scale. (3) Most substantively, four SPIRIT-C items were youth-generated and six youth-endorsed, with CONSORT-C items rooted in priorities from children and caregivers. That is the distinctive feature of these extensions and the submission misses it entirely. ONE OMISSION: the submission's 'age-stratified subgroup analyses' could not be confirmed as a specific item and is not asserted.

### Pediatrics 2026 #10 — Dual-AAV OTOF Gene Therapy for Congenital Auditory Neuropathy: The Paediatric Screening Consequence

**matched with corrections — real, and deliberately scoped to the paediatric angle**

Verified in the otolaryngology review of the same development: dual-AAV1 OTOF gene therapy, first-in-human restoration of hearing and speech perception published in Nature Medicine 2024, multicentre durability to 2.5 years in Nature 2026, age range extended beyond young children. TWO CORRECTIONS carried over. The construct is a DUAL-AAV vector, since the OTOF coding sequence exceeds single-AAV packaging capacity — the submission gets this right where earlier lists did not. And 'Rewrites pediatric otolaryngology and audiology guidelines, establishing targeted gene replacement as a viable alternative or adjunct to cochlear implants' overstates it: no guideline establishes this, and the population is a small minority of congenital hearing loss, so the entry says so. CROSS-SPECIALTY DUPLICATION, deliberate: this development also appears under otolaryngology for both years. It is kept here because the paediatric action — genetic testing triggered by a failed newborn hearing screen — is a different clinical behaviour from the otologist's, and the entry is written to the screening consequence rather than repeating the trial data. Same basis as the MeVO trials appearing in both emergency medicine and neurology.

### Plastic Surgery 2025 #1 — Apixaban versus Enoxaparin for VTE Chemoprophylaxis After Microsurgical Breast Reconstruction

**matched with corrections — real, scope and evidence level narrowed**

Verified: Plastic and Reconstructive Surgery, NCT04504318, a single-centre blinded randomised trial of apixaban versus enoxaparin in women undergoing microsurgical breast reconstruction with free abdominal flaps, concluding apixaban is a safe fixed-dose oral agent. The submission's rationale — weight-based dosing, factor Xa monitoring and injection burden with enoxaparin — checks out. TWO CORRECTIONS. (1) SCOPE: submitted as a trial in 'high-risk plastic and reconstructive surgery patients'; it is one operation in one population at one centre, and generalising it across plastic surgery is not supported. (2) EVIDENCE LEVEL: the submission calls it 'level-1 evidence supporting oral anticoagulation options without increasing post-operative hematoma or surgical-site bleeding risks' that 'directly challenges traditional surgical protocols'. The reported conclusion is safety; a single-centre trial not powered for VTE events does not overturn a protocol, and the entry says so.

### Plastic Surgery 2025 #3 — Extended Antibiotic Prophylaxis in Implant-Based Breast Reconstruction

**matched with corrections — supported, with the contrary earlier evidence restored**

Verified: Aesthetic Surgery Journal (doi 10.1093/asj/sjaf144), 16 studies with 8,173 extended-prophylaxis and 2,676 comparison patients, plus a 14-study 12,572-patient subgroup finding no difference in surgical site infection for antibiotics until drain removal. The submission's direction is supported by the most recent evidence. ONE CORRECTION of completeness: the submission presents this as settled ('demonstrating no statistically significant benefit to prolonged post-operative antibiotic therapy'). Earlier meta-analyses found extended prophylaxis DID significantly reduce infection risk in implant reconstruction, and the literature remains mixed, so the entry distinguishes 'newest and largest analyses show no benefit' from 'benefit has been excluded'. This is the same distinction applied to the extended-prophylaxis entry in the orthopaedics list, where the submission had the direction the other way round.

### Plastic Surgery 2025 #4 — Extracorporeal Shockwave Therapy for Post-Breast-Reconstruction Fibrosis

**corrected — described as double-blind; it is single-blinded**

Verified: JPRAS September 2025, S1748-6815(25)00533-9, 40 adult women, ESWT versus sham, eight sessions twice weekly over four weeks, three-month follow-up, stratified into three fibrosis categories, with significant patient- and observer-reported improvement in fibrosis size, softness, pain and shoulder mobility. TWO CORRECTIONS. (1) BLINDING: the submission calls it 'a double-blind, randomized controlled trial'. It is SINGLE-blinded — participants were blinded, clinicians administering the therapy were not, because the intervention is procedural. Since observer-reported domains were among the outcomes that improved, unblinded assessors are a real limitation and the entry states it. (2) The submission says the trial 'introduces a non-surgical management algorithm'; no algorithm was published — it is a trial result. Added n=40 and the three-month follow-up limit, since the submission implies an established office protocol.

### Plastic Surgery 2025 #5 — NivobotulinumtoxinA for Glabellar Lines With or Without Lateral Canthal Lines

**matched with corrections — the unusual drug name is genuine**

VERIFIED, AND A SUSPICION OF MINE WAS WRONG AGAIN. I flagged 'nivobotulinumtoxinA' as a probable garbled drug name, since the well-known ready-to-use liquid toxin is relabotulinumtoxinA. Nivobotulinumtoxin A is real: PMID 39587780, PMC11913111, two multicentre phase 3 double-blind randomised trials, Study 001 in glabellar lines and Study 005 in glabellar plus lateral canthal lines. This is the second time in this review that a name I expected to be an error turned out to be a genuine agent, after amivantamab in head and neck cancer. TWO ADDITIONS: the 36-month shelf life and the absence of human serum albumin, which are the actual distinguishing features and are missing from the submission; and an explicit warning not to conflate it with relabotulinumtoxinA (READY-1/READY-2), a separate product whose programme the submission's description could easily be read as. Added that toxin units are not interchangeable between products, which is the practical hazard when two similar liquid formulations reach the market together.

### Plastic Surgery 2025 #6 — Statistical Fragility of Acellular Dermal Matrix Outcomes in Breast Reconstruction

**matched with corrections — supported, with the numbers that make the point added**

Verified: 33 studies screened, 19 randomised trials, 204 outcomes, median fragility index 4 (IQR 3-5), fragility quotient 0.039, and among the 26 significant outcomes a median fragility index of 3.5 (IQR 1-5), with the conclusion that ADM outcomes are statistically fragile. ONE ADDITION and ONE SOFTENING. The numbers were missing from the submission and are the whole argument — a median fragility index of 3.5 means three or four patients changing outcome would remove significance, which is far more persuasive than the phrase 'high statistical fragility'. And the submission says the paper 'prompts a re-evaluation of routine ADM utilization guidelines'; the paper's stated recommendation is methodological (report fragility metrics with p values), with the clinical inference belonging to the reader — reworded accordingly, keeping the submission's sound patient-selection advice.

### Plastic Surgery 2025 #8 — International Expert Consensus on Enhancing Graft Survival in Follicular Unit Excision

**matched with corrections — real, specific parameters not confirmed**

Verified: Plastic and Reconstructive Surgery, December 2025, an international expert consensus giving recommendations across seven clinical issues in FUE — preoperative preparation, graft harvest, external dissection and trimming, graft preservation, graft implantation, postoperative care and complication prevention. The submission's 'all seven key phases' framing matches. ONE CORRECTION: the submission asserts that the consensus establishes 'definitive international standards for preoperative donor preparation, harvest punch velocity, chilled holding media formulation, and micro-site depth controls'. Those specific parameters could not be confirmed as the consensus content, so the seven verified domains are named instead, together with the punch-size trade-off (0.7-0.9 mm reducing scar visibility but increasing transection when misaligned) and the ischaemia-time point, which are documented and actionable. 'Definitive' is also softened — this is expert consensus, not trial evidence.

### Plastic Surgery 2025 #9 — Perioperative Management of GLP-1 Receptor Agonists in Surgical Patients

**corrected — the guidance is not a hold protocol, which is how it was submitted**

Real and important, but the emphasis is close to inverted. The submission describes 'perioperative hold guidelines specifically tailored to elective cosmetic and body contouring procedures' and 'clear preoperative protocols on when to hold GLP-1 medications'. The multisociety guidance (ASA, AGA, ASMBS, ISPCOP, SAGES) concluded that MOST PATIENTS CAN CONTINUE these drugs before elective surgery, using mitigation and individual risk stratification; holding is a shared decision, and only then is the day-of/one-week-before suggestion applied. A surgeon operating from the submitted version would stop these drugs unnecessarily. Rewritten to the actual position, with the two ASA operational rules (delay if GI symptoms present; gastric ultrasound if unheld and asymptomatic) and the evidence behind the concern (residual gastric content on prospective ultrasound, aspiration case reports despite adequate fasting, weekly formulations worst). NOTE ON AN INTERNAL CONTRADICTION: the 2026 list asserts 'strict anesthesia holds prior to elective surgery' as a standardised protocol, which conflicts with this guidance; that entry has been corrected to match.

### Plastic Surgery 2025 #10 — Prehabilitation in Plastic Surgery

**corrected — the benefit is extrapolated, not demonstrated in plastic surgery**

The review is real (Surgeries, doi 10.3390/surgeries7010037) and its components are accurately described: exercise, nutritional optimisation, risk factor modification and psychological preparation within an ERAS framework. THE KEY CORRECTION is what the review itself states and the submission omits: there have been NO randomised controlled trials of prehabilitation in plastic surgery. The submission claims the model 'demonstrably reduces wound breakdown and length of hospital stay' — that is not demonstrated in this specialty. The 20-40% complication reductions come from orthopaedic and colorectal trials in higher-risk populations, are heterogeneous, and are extrapolated. Corrected, with smoking cessation flagged as the component with independent evidence, so the entry remains actionable rather than merely deflating.

### Plastic Surgery 2026 #1 — Body Contouring After GLP-1-Driven Weight Loss

**corrected — the anaesthetic protocol contradicts the actual guidance**

The clinical phenomenon and the operative approaches are real and uncontroversial. ONE SUBSTANTIVE CORRECTION: the submission states that 'standardized perioperative protocols now require... strict anesthesia holds prior to elective surgery'. That is not the guidance. The multisociety statement (ASA, AGA, ASMBS, ISPCOP, SAGES) concluded most patients can CONTINUE GLP-1 receptor agonists before elective surgery with mitigation and individual risk stratification; a hold is a shared decision, and the operational rules are symptom-based delay plus gastric ultrasound where appropriate. This also contradicted the 2025 list's own entry on the same topic, so both have been aligned to the guidance. The six-month weight stabilisation figure is a reasonable practice convention and is labelled as one rather than as a validated requirement, since I could not verify a specific evidence-based threshold. Specific nutritional tests added to make the screening advice actionable.

### Plastic Surgery 2026 #2 — Anatomy-First Sizing and Hybrid Breast Augmentation

**corrected — a practice trend described as a guideline update**

The trend is real and widely described. TWO CORRECTIONS. (1) The submission says this 'updates clinical practice guidelines to favor subglandular or prepectoral placement alongside micro-fat grafting'. No clinical practice guideline endorsing a specific plane or hybrid technique was found; this is an evolution in practice, and the entry says so. Terminology also matters here — 'prepectoral' is the standard term in implant-based reconstruction, while subglandular or subfascial describes above-muscle placement in cosmetic augmentation, and the submission uses them interchangeably. (2) The submission's claim of 'minimizing implant-related complications and revision surgeries over time' is not established for hybrid augmentation. ADDED, because the submission omits it and it has real downstream consequences: grafted breast fat can generate calcifications and cysts that complicate subsequent mammography, so the grafting must be documented and disclosed at future imaging.

### Plastic Surgery 2026 #4 — Conservative Facial Rejuvenation: Deep-Plane and Minimal-Access Techniques

**corrected — two distinct operations conflated, and one claim not supported**

The trend toward SMAS repositioning over skin excision is real and well established in the specialty. TWO CORRECTIONS. (1) The submission groups 'targeted Minimal Access Cranial Suspension (MACS) and deep-plane mini-facelifts' as a single conservative approach. They are different operations with different dissections, different risk profiles and different indications — MACS is a short-scar suspension technique, deep-plane involves releasing retaining ligaments with facial nerve risk in defined zones. Treating them as interchangeable would misinform a trainee about both. (2) The submission claims 'shorter operative times and faster recoveries'; deep-plane dissection is technically demanding and not intrinsically faster than a skin-only lift, and no source was found supporting shorter operative time for the deep-plane approach. No guideline change underlies this entry — it is a practice pattern, which the entry now reflects.

### Plastic Surgery 2026 #5 — AI-Assisted 3D Preoperative Simulation and Tissue Mapping

**corrected — the outcome claim is unsupported and creates a consent risk**

The technology is real and in use. ONE CORRECTION, with a practical edge: the submission says AI-assisted simulation 'significantly lowers revision rates'. No study demonstrating a reduction in revision rates was found, and this is precisely the kind of claim that becomes a problem in a dissatisfied-patient conversation — a simulation shown during consultation can be understood by the patient as a promise of outcome. The entry keeps the genuine benefit (shared expectation-setting, documented in consent) and states plainly that predictive accuracy for soft-tissue settlement is not established. No guideline standardises preoperative planning protocols around these tools, contrary to the submission's guideline-impact line.

### Plastic Surgery 2026 #6 — Biostimulatory Agents versus Volumising Fillers

**corrected — the safety comparison omits the trade-off that matters most**

The shift toward biostimulators (poly-L-lactic acid, calcium hydroxylapatite) for diffuse laxity is real and is reflected in the GLP-1 aesthetic consensus on the 2025 list. ONE SUBSTANTIVE CORRECTION: the submission says biostimulators deliver structural restoration 'without risks of filler migration or chronic edema', framing them as the safer option. They have their own adverse-event profile including nodules, late-onset granuloma and contour irregularity, and — the decisive point the submission omits — they are NOT reversible with hyaluronidase, unlike hyaluronic acid fillers. A clinician who adopted these believing them lower-risk would have removed their own safety net. Also softened 'clinical guidelines now recommend biostimulators as primary non-surgical intervention tools': the supporting document is an industry-commissioned expert consensus, not a guideline. Gradual onset added as a consent point.

### Plastic Surgery 2026 #7 — Preventative Aesthetic Intervention in Younger Patients ("Prejuvenation")

**corrected — the central premise has no supporting evidence**

The trend is real; the mechanism claimed for it is not established. The submission says prejuvenation 'Prevents severe structural laxity from accumulating' and 'Redefines clinical entry thresholds for aesthetic surgery, establishing safety guidelines for early-intervention procedures'. No evidence that early micro-dosed intervention prevents later laxity was found, and no guideline establishing entry thresholds or safety standards for early intervention was located. Since this entry concerns offering procedures to young and often adolescent-adjacent patients on the basis of an unproven preventive claim, the entry states the absence of evidence directly and adds the two screening obligations — body dysmorphic disorder and expectation, and the lifetime maintenance commitment — that the submission omits entirely.

### Plastic Surgery 2026 #8 — Combining Surgical Correction with Energy-Based Skin Treatment

**corrected — described as an integrated care algorithm; no such protocol exists**

The combination approach is really practised and the underlying rationale is sound. ONE CORRECTION: the submission says this 'Replaces isolated treatment plans with integrated care algorithms'. No consensus or published algorithm defining safe concurrent surgical and energy-based combinations was found, so it is surgeon judgement rather than an established pathway. ADDED, because the submission presents concurrent treatment as straightforwardly beneficial and omits the hazard: energy delivered to a recently elevated flap can compromise perfusion, so plane, extent of dissection and sequencing determine safety, and skin phototype governs resurfacing risk separately. The claim that this 'maximizes overall aesthetic quality and longevity' is not evidenced and is not asserted.

### Plastic Surgery 2026 #9 — Ultrasound Guidance for Gluteal Fat Grafting

**matched with corrections — real, and better documented than submitted**

Verified and the best-supported entry in the 2026 list: the Florida Department of Health mandated ultrasound imaging for all gluteal fat transfer in 2023, with ASPS and The Aesthetic Society support and a joint safety statement; a 1,815-patient retrospective series reported an improved safety profile with no deaths or fat embolism; a systematic review and meta-analysis exists in Aesthetic Surgery Journal; and fatalities are attributed principally to intramuscular rather than subcutaneous fat placement. TWO CORRECTIONS. (1) The submission says ultrasound guidance is 'Codif[ied] standardized safety guidelines across international plastic surgery societies'. It is a US state law from 2023 plus national society endorsement — not international codification — and a surgeon outside Florida is not under the same legal requirement even though the safety rationale applies everywhere. (2) The date is 2023 for the mandate, not 2026; the supporting evidence extends through 2026. Added the 1,815-patient series and the specific mechanism of death, both absent from the submission.

### Plastic Surgery 2026 #10 — Enhanced Recovery and Opioid-Sparing Perioperative Analgesia

**matched with corrections — direction sound, one named agent flagged as contested**
...
The guideline is real (August 2025) and three submitted points check out exactly: PREVENT replacing the Pooled Cohort Equations with renal function and social drivers of health added, primary aldosteronism screening expanded to all stage 2 or resistant hypertension, and renal denervation newly included. THREE CORRECTIONS. (1) Renal denervation is a QUALIFIED option — selected patients, eGFR ≥40, uncontrolled on optimal therapy or intolerant, with multidisciplinary team guidance; 'formally incorporates renal denervation for resistant hypertension' reads far broader. (2) NOT CONFIRMED: the submission says the guideline 'actively encourag[es] <120/80 mmHg for most adults'. Reporting on the guideline states the definitions and stage thresholds are unchanged from 2017, and I could not confirm a <120/80 target recommendation, so it is not asserted. (3) NOT CONFIRMED: the claim that it 'establishes firm blood pressure targets to prevent cognitive impairment/dementia' and 'formally recommends target blood pressure reduction specifically to lower the risk of mild cognitive impairment and vascular dementia'. Plausible given SPRINT MIND, but I could not verify it as a recommendation in this guideline. Also softened 'routine out-of-office blood pressure monitoring is mandated' — guidelines recommend rather than mandate.

### Preventive Medicine 2025 #2 — Tirzepatide for Obesity Treatment and Diabetes Prevention (SURMOUNT-1, 176 Weeks)

**matched with corrections — figures confirmed, estimand and date clarified**

Verified: NEJMoa2410819, PMID 39536238, 2,539 participants with 1,032 prediabetic, 176 weeks plus a 17-week off-treatment period. The 94% risk reduction and the 98.7% diabetes-free figure are both accurate (1.3% versus 13.3% onset). TWO CORRECTIONS. (1) The submission's 'sustained weight reductions up to 22.9%' is the efficacy estimand for the 15-mg dose; the mean percent change reported at 176 weeks was −19.7% at 15 mg (−12.3% at 5 mg, −18.7% at 10 mg) versus −1.3% on placebo. Citing only 22.9% presents the most favourable analysis without saying so, so both are given. (2) Date: published 13 November 2024, not 2025. Added the 17-week off-treatment period, since the submission frames this as arresting metabolic deterioration without noting that the benefit is tied to continued treatment.

### Preventive Medicine 2025 #3 — Lepodisiran, a Long-Duration siRNA Targeting Lipoprotein(a) (ALPACA)

**matched with corrections — durability figure was overstated**

Verified: phase 2 ALPACA, presented at ACC 2025 with simultaneous NEJM publication, single subcutaneous dose, 93.9% mean Lp(a) reduction over days 60-180 at 400 mg. ONE CORRECTION: the submission says levels were lowered 'by over 94% for up to a full year'. The 93.9% figure is the day 60-180 average; at one year the reduction is approximately 90%, and at 18 months approximately 75%. The submitted phrasing merges the peak effect with the durability window. Corrected, with the 18-month figure added because it is what supports the annual-dosing case the submission makes. Also stated explicitly that phase 2 shows biomarker lowering, not event reduction — the submission's 'eliminate residual genetic risk' presumes the outcome trial has already succeeded.

### Preventive Medicine 2025 #4 — ACIP Lowers Universal Pneumococcal Vaccination to Age 50

**matched with corrections — one vaccine option omitted**

Verified: ACIP voted 14:1 to lower the age-based recommendation from 65 to 50 and the CDC endorsed it; the rationale is disease burden in the 50-64 group. TWO CORRECTIONS. (1) The submission lists only 'single-dose PCV20 or PCV21 (Capvaxive)'. PCV15 also remains an option for this age group, with PPSV23 one year later — omitting it would have a clinician turn away a patient offered PCV15, or miss the follow-up dose. (2) Date: the ACIP vote was October 2024, with MMWR publication following; the submission dates it to 2025. ADDED: the serotype coverage difference (about 84% of invasive disease for PCV21 versus about 52% for PCV20 in adults 50+), which is the practical basis for choosing between them and is absent from the submission.

### Preventive Medicine 2025 #5 — USPSTF Recommendation: Screening for Breast Cancer Starting at Age 40

**matched with corrections — figure and date, and the conflict is not fully resolved**

Verified: biennial mammography ages 40-74, Grade B, published in JAMA 11 June 2024 following the 30 April 2024 announcement, PMID 38687503. THREE CORRECTIONS. (1) FIGURE: the estimate is 19% more lives saved, not the 20% submitted. (2) Date: 2024, not 2025. (3) The submission says the update 'resolv[es] longstanding policy conflicts between preventive task forces and specialty oncology societies'. It aligned the starting age, but the interval remains contested — several societies recommend annual rather than biennial screening — so the conflict is narrowed rather than resolved. ADDED: the 40% higher breast cancer mortality in Black women, which the Task Force cites as a reason for the change and which the submission omits entirely, and the insufficient-evidence statement on supplemental imaging for dense breasts.

### Preventive Medicine 2025 #6 — Semaglutide and Cardiovascular Outcomes in Obesity without Diabetes (SELECT)

**matched with corrections — one figure not confirmed, two major findings added**

Verified: SELECT, NEJMoa2307563, PMID 37952131, 17,604 participants (8,803 semaglutide / 8,801 placebo), 804 sites in 41 countries, mean follow-up 39.8 months, 20% reduction in major adverse cardiovascular events in adults with BMI ≥27 and established cardiovascular disease without diabetes. THREE CORRECTIONS. (1) NOT CONFIRMED: the submission claims 'heart failure outcomes by 18%'. I could not verify an 18% heart failure figure and it is not asserted; the confirmed secondary findings are given instead. (2) Date: November 2023, not 2025. (3) The submission states that ACC/AHA and ADA guidelines were updated to recommend GLP-1 receptor agonists in non-diabetic secondary prevention on the basis of this trial; I did not verify those guideline updates, so the entry describes the trial evidence rather than asserting guideline text. ADDED: the 73% reduction in incident diabetes and the roughly 22% improvement in renal outcomes, both absent from the submission and both larger effects than the primary endpoint.

### Preventive Medicine 2025 #7 — Oral Muvalaplin for Lowering Lipoprotein(a) (KRAKEN)
...
### Psychiatry 2025 #1 — Esketamine Nasal Spray as Monotherapy for Treatment-Resistant Depression

**matched with corrections — journal unconfirmed, and the monitoring burden was omitted**

Verified: the FDA approved Spravato as the first and only monotherapy for TRD on 21 January 2025, on the basis of NCT04599855 — 378 adults, esketamine 56 mg or 84 mg versus placebo twice weekly for four weeks, LS mean differences −5.1 and −6.8 (P<.001), separation by 24 hours, remission 22.5% versus 7.6%. THREE CORRECTIONS. (1) JOURNAL NOT CONFIRMED: the submission cites JAMA Psychiatry; I could not verify the publication venue, so the trial registration and the FDA approval are cited instead. (2) The effect sizes and remission rates were absent — 22.5% remission is a meaningful but modest absolute figure and belongs in any patient conversation. (3) The submission says monotherapy 'reduces polypharmacy burdens' and lists the oral-antidepressant side effects avoided, without noting that esketamine is REMS-restricted, given in a certified setting with two hours of post-dose observation for sedation, dissociation and blood pressure rise. A clinician told only the first half would misjudge what they are offering. Note also that TRD3005 — a trial name adjacent to this programme — studied esketamine WITH an oral antidepressant in patients 65 and over, and is not the monotherapy evidence.

### Psychiatry 2025 #2 — Lithium versus Quetiapine Augmentation for Treatment-Resistant Depression (LQD)

**corrected — the trial acronym is invented, and the design was open-label**

The trial is real and the direction is right: Cleare et al., The Lancet Psychiatry, April 2025, doi 10.1016/S2215-0366(25)00028-8, PMID 40350798, with quetiapine more clinically and cost-effective than lithium over 52 weeks. FOUR CORRECTIONS. (1) NAME: the submission calls it the 'LITH-QUE Trial'. It is the LQD trial — an invented acronym sends a reader looking for a study that does not exist under that name. (2) DESIGN: submitted as giving 'high-level, long-term comparative data'; it is pragmatic and OPEN-LABEL, not blinded, with 212 participants at six sites, 89% White. (3) The discontinuation figures — roughly 50% on lithium and 39% on quetiapine stopping within a year, usually for side effects — were missing and are the most practically important result. (4) The claim that quetiapine avoids 'the intensive laboratory monitoring (renal/thyroid) required for lithium' is only half the picture, since quetiapine carries metabolic monitoring, sedation and weight gain. The submitted assertion that this 'elevates atypical antipsychotic augmentation... in major depressive disorder practice guidelines' could not be confirmed and is not asserted.

### Psychiatry 2025 #5 — Xanomeline-Trospium (Cobenfy) in Schizophrenia: Implementation Guidance

**corrected — the mechanism was misdescribed and the side-effect claim is one-sided**

The drug is real and the significance is genuine: xanomeline-trospium (Cobenfy) is the first schizophrenia treatment approved that does not act through dopamine D2 blockade. TWO CORRECTIONS. (1) MECHANISM: the submission calls it 'the first dual M1/M4 muscarinic receptor agonist'. That describes xanomeline alone. Trospium is a peripherally restricted muscarinic ANTAGONIST, included to reduce peripheral cholinergic adverse effects — so the product is an agonist-plus-antagonist combination, and describing it as a dual agonist misrepresents why the second molecule is there. (2) The submission says it treats positive, negative and cognitive symptoms 'without exposing patients to extrapyramidal side effects, tardive dyskinesia, hyperprolactinemia, or metabolic weight gain' — listing only the harms avoided. The gastrointestinal burden is substantial and is a leading cause of discontinuation, and hepatic safety requires attention; both are now stated. The specific consensus panel report in The Journal of Clinical Psychiatry could not be verified, so the entry cites the prescribing information and describes the implementation literature generically. Its claim that guidelines now position muscarinic agonists as early-line is not asserted.

### Psychiatry 2025 #8 — CT-155, a Prescription Digital Therapeutic for Negative Symptoms of Schizophrenia (CONVOKE)

**corrected — a protocol was cited as results**

CT-155 is a real investigational prescription digital therapeutic for experiential negative symptoms of schizophrenia and CONVOKE is its trial programme. THE CORRECTION IS THE EVIDENCE STATUS. The submission describes 'results from the landmark CONVOKE Phase 3 trial' and says the findings 'incorporate prescription digital therapeutics into evidence-based guidelines as standard adjunctive care' — while citing JMIR Research Protocols, a journal that publishes study protocols. A protocol is a plan, not a result, and no results publication or guideline incorporation was verified. Rewritten so the entry conveys what the intervention targets and what to ask of the eventual evidence, without asserting efficacy. Added the comparator point — sham app versus waitlist — because engagement-dependent interventions in a condition defined partly by avolition are especially vulnerable to it. The specific url could not be resolved to an article, so the journal is cited; flagged for the physician to supply the results paper if it exists.

### Psychiatry 2026 #1 — Dose-Effect Network Meta-Analysis of ADHD Pharmacotherapy

**matched with corrections — accurate, with the guideline claim softened**

Verified and accurately described: The Lancet Psychiatry, June 2026, 113 double-blind randomised trials, 14,138 children/adolescents and 11,016 adults (the submission's '25,000+ patients' is correct), Bayesian hierarchical network model with restricted cubic splines, oral stimulant and non-stimulant monotherapy from age 5, efficacy on validated scales with tolerability as discontinuation due to adverse events. The best-sourced entry in this list. TWO CHANGES. The age breakdown, design and tolerability endpoint were added, since a dose-effect analysis is only interpretable if you know efficacy and tolerability curves are separate. And the claim that it 'updates international ADHD prescribing guidelines' is softened — the analysis informs guidelines rather than constituting one, and no guideline revision was verified.

### Psychiatry 2026 #2 — Interleukin-6 Receptor Blockade with Tocilizumab in Difficult-to-Treat Depression

**matched with corrections — real, but the risk profile and a contrary trial were omitted**

Verified: JAMA Psychiatry proof-of-concept randomised trial of IL-6 receptor inhibition with tocilizumab in difficult-to-treat depression linked to low-grade inflammation, 54% remission, with improvement correlating with baseline hs-CRP better than IL-6. THREE CORRECTIONS. (1) The trial is a PILOT proof-of-concept and its remission and response rates are described as NUMERICALLY favouring tocilizumab — the submission presents 54% as an established treatment effect. (2) OMITTED CONTRARY EVIDENCE: an earlier study found tocilizumab associated with worse depression and related symptoms in medically ill patients, so the effect is not consistent across populations. (3) SAFETY OMITTED ENTIRELY: the submission recommends clinicians 'order routine inflammatory panels... to evaluate candidates for adjunctive biologic anti-inflammatory interventions' without mentioning that tocilizumab is an immunosuppressant carrying risk of serious infection, TB reactivation, hepatotoxicity and GI perforation, and is not approved for depression. A psychiatrist acting on the submitted version could expose a patient to those risks on the strength of one pilot trial.

### Radiation Oncology 2025 #2 — Omitting Regional Nodal Irradiation After Nodal Conversion to ypN0 (NSABP B-51 / RTOG 1304)

**matched with corrections — verified, guideline attribution softened**

Verified: NSABP B-51 / RTOG 1304, NEJMoa2414859, 1,556 patients with ypN0 after neoadjuvant chemotherapy randomised to regional nodal irradiation (772) or none (784), median follow-up 59.5 months, invasive breast cancer recurrence-free interval 92.7% versus 91.8% (HR 0.88, P = 0.51), 5-year overall survival 93.6% versus 94.0%. The submission's direction is exactly right and the figures have been added. TWO CORRECTIONS. (1) The submission titles this as 'ASTRO-ASCO-SSO Joint Postmastectomy Radiation Therapy Guidelines' and says it 'formally establishes' the omission; the trial is the evidence, and I could not confirm a 2025 joint guideline update incorporating it, so the trial is the anchor. (2) Added the eligibility boundary — clinically node-positive before chemotherapy, pathologically node-negative after — because that is the population, and the five-year follow-up limit, since a de-escalation decision turns on late as well as early recurrence.

### Radiation Oncology 2025 #9 — Stereotactic Arrhythmia Radioablation for Refractory Ventricular Arrhythmia
...
### Thoracic Surgery 2025 #8 — DECIPHER-NODL: Imaging Plus cfDNA Fragmentomics for Pulmonary Nodules

**matched with corrections — model real and strong, but it is not prospective and not in any guideline**
...
### Cardiology 2025 #1 — 2025 ACC/AHA/ACEP/NAEMSP/SCAI Guideline for the Management of Patients With Acute Coronary Syndromes

**matched**

Real and accurately summarised. Circulation DOI 10.1161/CIR.0000000000001309, also JACC 2025;85(22):2135-2237, PMID 40014670. The five-society authorship, the consolidation of the three prior documents, potent P2Y12 preference and ezetimibe co-initiation all check out. Only change: 'Mandates' softened to 'Recommends' — a guideline recommends; it does not mandate.

### Cardiology 2026 #2 — 2026 AHA/ACC/ADA/ASN Guideline for the Prevention, Detection, Evaluation, and Management of Cardiovascular-Kidney-Metabolic (CKM) Syndrome

**matched**

Real and accurately summarised. JACC DOI 10.1016/j.jacc.2026.03.056, issued 9 June 2026 by ACC/AHA/ADA/ASN. Stages 0-4 with the 4a/4b split, PREVENT for 10- and 30-year risk, and the multi-society authorship all confirmed. Added that it is the first-ever such guideline, that staging applies to youths as well as adults, and that stage regression is an explicit goal — all three strengthen the entry. The specific drug classes named were not individually confirmed from the abstract but are consistent with the framework.

### Dermatology 2025 #1 — Focused Update: Guidelines of Care for the Management of Atopic Dermatitis in Adults

**matched**

Real and accurately summarised. JAAD, September 2025, DOI 10.1016/j.jaad.2025.05.1386. All four drugs, their mechanisms, the severity bands and the STRONG recommendation strength were confirmed, as was that nemolizumab is recommended WITH concomitant topical therapy. One of the cleanest entries across all submitted lists.

### Dermatology 2026 #1 — AAD Guidelines of Care for the Primary Prevention of Atopic Dermatitis and Awareness of Comorbid Conditions in Pediatric Atopic Dermatitis

**matched**

A JAAD 2026 document with this scope was located (S0190-9622(26)00344-0), covering primary prevention of atopic dermatitis and comorbidity awareness in pediatric AD. The title has been aligned to the located article. The individual drug lists and the specific recommendation strengths were not confirmed item by item from the abstract, so treat the graded specifics as needing a read of the document itself.

### Dermatology 2026 #4 — Vixarelimab in Patients With Prurigo Nodularis: A Randomized Clinical Trial
...
### Orthopaedic Surgery 2025 #4 — Perioperative Opioid Counseling Before ACL Reconstruction (Randomized Controlled Trial)
...
Verified and accurate as submitted, including the Phoenix score ≥2 threshold, the four organ systems, and all three cardiovascular criteria for septic shock (severe hypotension for age, lactate >5 mmol/L, vasoactive requirement). Two additions rather than corrections: the date is February 2024, not 2025, and the in-hospital mortality figures have been added because they are what justify the cut-off and the submission omits them. One softening: the submission says the criteria 'significantly reduce false-positive sepsis alarms in pediatric emergency departments and ICUs'. That is the design intent and the direction of separate prospective comparisons against the 2005 criteria, but it is not a finding of the consensus paper itself, so it is not stated as one.

### Psychiatry 2025 #3 — Serial Ketamine Infusions Added to Inpatient Care for Depression (KARMA-Dep 2)
