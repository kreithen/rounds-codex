...
303 entries checked. Grouped worst-first by what a reader would take away if the
...
| verdict | entries |
|---|---|
| Findings stated backwards — a reader would learn the opposite of the published result | 23 |
...
| Corrected — dates, journals, numbers, strength of claim | 173 |
