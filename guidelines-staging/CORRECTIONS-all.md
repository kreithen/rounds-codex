...
320 entries checked. Grouped worst-first by what a reader would take away if the
...
| verdict | entries |
|---|---|
| Findings stated backwards — a reader would learn the opposite of the published result | 24 |
| Cited study could not be found | 16 |
| Evidence level inflated — case report presented as a trial | 2 |
| Citation not independently verified | 63 |
| Wrong study or replaced | 18 |
| Corrected — dates, journals, numbers, strength of claim | 186 |
| Matched — no correction needed | 11 |
