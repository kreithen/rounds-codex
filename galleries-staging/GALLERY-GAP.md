...
Generated by `scripts/gen_gallery_gap.py` from the live app: **100 of 183 conditions have a gallery**, 83 do not.
**Page sizes are not uniform:** 650 of 1000 pages are the 1024x1536 standard; the rest are 800x1200 x212, 1138x1707 x40, 1280x1920 x30, 915x1373 x27. See `REEXPORT-REQUEST-1024x1536.md` (10 pages x100).
