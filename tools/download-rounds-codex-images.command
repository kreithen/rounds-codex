...
#
# Generated by tools/build_download_command.py -- do not hand-edit.

cd "$(dirname "$0")" || exit 1
mkdir -p rounds-codex-images && cd rounds-codex-images || exit 1
echo "Downloading 190 images into $(pwd)"

# These prompts were corrected and re-fired, so the id keeps its filename while the
# image behind it changed. Delete any stale copy first -- the skip-if-present guard
# below would otherwise keep the old, wrong image forever.
replaced=0
if [ -f "s1-0118.png" ]; then rm -f "s1-0118.png"; replaced=$((replaced+1)); fi
if [ -f "s1-0184.png" ]; then rm -f "s1-0184.png"; replaced=$((replaced+1)); fi
if [ -f "s1-0188.png" ]; then rm -f "s1-0188.png"; replaced=$((replaced+1)); fi
if [ -f "s1-0206.png" ]; then rm -f "s1-0206.png"; replaced=$((replaced+1)); fi
if [ -f "s2ck-0017.png" ]; then rm -f "s2ck-0017.png"; replaced=$((replaced+1)); fi
if [ -f "s2ck-0051.png" ]; then rm -f "s2ck-0051.png"; replaced=$((replaced+1)); fi
if [ -f "s2ck-0127.png" ]; then rm -f "s2ck-0127.png"; replaced=$((replaced+1)); fi
if [ -f "s2ck-0162.png" ]; then rm -f "s2ck-0162.png"; replaced=$((replaced+1)); fi
if [ "$replaced" -gt 0 ]; then echo "Replacing $replaced superseded image(s) of 8 re-fired"; fi
...
if [ -s "s1-0118.png" ]; then skip=$((skip+1)); else
  if curl -fsS --retry 3 --retry-delay 2 -o "s1-0118.png" "https://d8j0ntlcm91z4.cloudfront.net/user_3FrDA30hCddPXDrT7OjkBImfcd4/hf_20260802_131023_0e89f892-e6b6-4f66-9913-f48d350bfe9d.png"; then ok=$((ok+1)); printf "."; else fail=$((fail+1)); printf "X"; rm -f "s1-0118.png"; fi
fi
...
if [ -s "s1-0184.png" ]; then skip=$((skip+1)); else
  if curl -fsS --retry 3 --retry-delay 2 -o "s1-0184.png" "https://d8j0ntlcm91z4.cloudfront.net/user_3FrDA30hCddPXDrT7OjkBImfcd4/hf_20260802_131037_289c9dea-9916-47a7-bd1f-08634a042777.png"; then ok=$((ok+1)); printf "."; else fail=$((fail+1)); printf "X"; rm -f "s1-0184.png"; fi
fi
...
if [ -s "s1-0188.png" ]; then skip=$((skip+1)); else
  if curl -fsS --retry 3 --retry-delay 2 -o "s1-0188.png" "https://d8j0ntlcm91z4.cloudfront.net/user_3FrDA30hCddPXDrT7OjkBImfcd4/hf_20260802_131047_d130de28-bc17-414c-aed8-f861bc1c3657.png"; then ok=$((ok+1)); printf "."; else fail=$((fail+1)); printf "X"; rm -f "s1-0188.png"; fi
fi
...
if [ -s "s1-0206.png" ]; then skip=$((skip+1)); else
  if curl -fsS --retry 3 --retry-delay 2 -o "s1-0206.png" "https://d8j0ntlcm91z4.cloudfront.net/user_3FrDA30hCddPXDrT7OjkBImfcd4/hf_20260802_131055_10f2963b-0ec0-416f-af7b-343a211e2776.png"; then ok=$((ok+1)); printf "."; else fail=$((fail+1)); printf "X"; rm -f "s1-0206.png"; fi
fi
...
if [ -s "s2ck-0017.png" ]; then skip=$((skip+1)); else
  if curl -fsS --retry 3 --retry-delay 2 -o "s2ck-0017.png" "https://d8j0ntlcm91z4.cloudfront.net/user_3FrDA30hCddPXDrT7OjkBImfcd4/hf_20260802_131103_93b383ce-3700-4aee-bdb9-dc8cb86be007.png"; then ok=$((ok+1)); printf "."; else fail=$((fail+1)); printf "X"; rm -f "s2ck-0017.png"; fi
fi
...
if [ -s "s2ck-0051.png" ]; then skip=$((skip+1)); else
  if curl -fsS --retry 3 --retry-delay 2 -o "s2ck-0051.png" "https://d8j0ntlcm91z4.cloudfront.net/user_3FrDA30hCddPXDrT7OjkBImfcd4/hf_20260802_131115_e4468773-bef8-4e37-a640-1b6f218a69b3.png"; then ok=$((ok+1)); printf "."; else fail=$((fail+1)); printf "X"; rm -f "s2ck-0051.png"; fi
fi
...
if [ -s "s2ck-0127.png" ]; then skip=$((skip+1)); else
  if curl -fsS --retry 3 --retry-delay 2 -o "s2ck-0127.png" "https://d8j0ntlcm91z4.cloudfront.net/user_3FrDA30hCddPXDrT7OjkBImfcd4/hf_20260802_131124_af4a4537-fcb3-4c02-95cd-0a3ccdce1c63.png"; then ok=$((ok+1)); printf "."; else fail=$((fail+1)); printf "X"; rm -f "s2ck-0127.png"; fi
fi
...
if [ -s "s2ck-0162.png" ]; then skip=$((skip+1)); else
  if curl -fsS --retry 3 --retry-delay 2 -o "s2ck-0162.png" "https://d8j0ntlcm91z4.cloudfront.net/user_3FrDA30hCddPXDrT7OjkBImfcd4/hf_20260802_131132_6194273b-683b-44d2-b9d8-b3f635593c7b.png"; then ok=$((ok+1)); printf "."; else fail=$((fail+1)); printf "X"; rm -f "s2ck-0162.png"; fi
fi
...
if [ "$fail" -gt 0 ]; then echo "Re-run this script to retry the failures."; fi
